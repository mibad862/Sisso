...
mixin OverrideTranslateMixin on OverrideTranslateActionMixin implements S {
  ...
  String get continueToPreview =>
      getCustomTranslate('continueToPreview', parent.continueToPreview);
  ...
  /// `Your Rating`
  @override
  String get yourRating => getCustomTranslate('yourRating', parent.yourRating);
  ...
  /// `Schedule Sale`
  @override
  String get scheduleSale =>
      getCustomTranslate('scheduleSale', parent.scheduleSale);

  /// `Sale From Date`
  @override
  String get saleFromDate =>
      getCustomTranslate('saleFromDate', parent.saleFromDate);

  /// `Sale To Date`
  @override
  String get saleToDate => getCustomTranslate('saleToDate', parent.saleToDate);
  ...
  /// `On Hold`
  @override
  String get onHold => getCustomTranslate('onHold', parent.onHold);

  /// `Failed`
  @override
  String get failed => getCustomTranslate('failed', parent.failed);

  /// `Completed`
  @override
  String get completed => getCustomTranslate('completed', parent.completed);

  /// `Refunded`
  @override
  String get refunded => getCustomTranslate('refunded', parent.refunded);
  ...
  /// `Children`
  @override
  String get children => getCustomTranslate('children', parent.children);

  /// `Ages 2–12`
  @override
  String get childrenDesc =>
      getCustomTranslate('childrenDesc', parent.childrenDesc);

  /// `Infants`
  @override
  String get infants => getCustomTranslate('infants', parent.infants);

  /// `Under 2`
  @override
  String get infantsDesc =>
      getCustomTranslate('infantsDesc', parent.infantsDesc);

  /// `Animals`
  @override
  String get animals => getCustomTranslate('animals', parent.animals);
  ...
  String get pendingPayment =>
      getCustomTranslate('pendingPayment', parent.pendingPayment);
  ...
  /// `Reversed`
  @override
  String get reversed => getCustomTranslate('reversed', parent.reversed);

  /// `Canceled Reversal`
  @override
  String get canceledReversal =>
      getCustomTranslate('canceledReversal', parent.canceledReversal);

  /// `Charge Back`
  @override
  String get chargeBack => getCustomTranslate('chargeBack', parent.chargeBack);

  /// `Denied`
  @override
  String get denied => getCustomTranslate('denied', parent.denied);

  /// `Processed`
  @override
  String get processed => getCustomTranslate('processed', parent.processed);

  /// `Voided`
  @override
  String get voided => getCustomTranslate('voided', parent.voided);
  ...
  String get featureImage =>
      getCustomTranslate('featureImage', parent.featureImage);
  ...
  String get deliveryTime =>
      getCustomTranslate('deliveryTime', parent.deliveryTime);
  ...
  /// `Banner`
  @override
  String get banner => getCustomTranslate('banner', parent.banner);
  ...
  String get expectedDeliveryTime =>
      getCustomTranslate('expectedDeliveryTime', parent.expectedDeliveryTime);
  ...
  /// `Top Brands`
  @override
  String get topBrands => getCustomTranslate('topBrands', parent.topBrands);
  ...
  /// `Quote`
  @override
  String get quoteLabel => getCustomTranslate('quoteLabel', parent.quoteLabel);

  /// `Submit quote request`
  @override
  String get submitQuoteRequest =>
      getCustomTranslate('submitQuoteRequest', parent.submitQuoteRequest);
  ...
  @override
  String get pleaseAllowAccessLocation => getCustomTranslate(
    'pleaseAllowAccessLocation',
    parent.pleaseAllowAccessLocation,
  );

  /// `Enter your current location`
  @override
  String get enterYourCurrentLocation => getCustomTranslate(
    'enterYourCurrentLocation',
    parent.enterYourCurrentLocation,
  );
  ...
  /// `Write your title (Optional)`
  @override
  String get writeTitleOptional =>
      getCustomTranslate('writeTitleOptional', parent.writeTitleOptional);
  ...
  /// `Types`
  @override
  String get types => getCustomTranslate('types', parent.types);

  /// `Regions`
  @override
  String get regions => getCustomTranslate('regions', parent.regions);
  ...
  /// `Approved - Unpaid`
  @override
  String get approvedUnpaid =>
      getCustomTranslate('approvedUnpaid', parent.approvedUnpaid);

  /// `Approved - Paid`
  @override
  String get approvedPaid =>
      getCustomTranslate('approvedPaid', parent.approvedPaid);

  /// `Waiting for owner confirmation`
  @override
  String get waitingOwnerConfirmation => getCustomTranslate(
    'waitingOwnerConfirmation',
    parent.waitingOwnerConfirmation,
  );

  /// `Booking deleted successfully`
  @override
  String get bookingDeletedSuccessfully => getCustomTranslate(
    'bookingDeletedSuccessfully',
    parent.bookingDeletedSuccessfully,
  );

  /// `Booking cancelled successfully`
  @override
  String get bookingCancelledSuccessfully => getCustomTranslate(
    'bookingCancelledSuccessfully',
    parent.bookingCancelledSuccessfully,
  );

  /// `Are you sure you want to cancel this booking?`
  @override
  String get confirmCancelBooking =>
      getCustomTranslate('confirmCancelBooking', parent.confirmCancelBooking);

  /// `Are you sure you want to delete this booking?`
  @override
  String get confirmDeleteBooking =>
      getCustomTranslate('confirmDeleteBooking', parent.confirmDeleteBooking);

  /// `Get Ticket`
  @override
  String get getTicket => getCustomTranslate('getTicket', parent.getTicket);

  /// `Booking requested on: {date}`
  @override
  String bookingRequestedOn(Object date) => getCustomTranslate(
    'bookingRequestedOn',
    parent.bookingRequestedOn(date),
    args: {'date': date},
  );

  /// `Payment due: {date}`
  @override
  String paymentDue(Object date) => getCustomTranslate(
    'paymentDue',
    parent.paymentDue(date),
    args: {'date': date},
  );
  ...
  String get bookingLocation =>
      getCustomTranslate('bookingLocation', parent.bookingLocation);

  /// `Booking Details`
  @override
  String get bookingDetails =>
      getCustomTranslate('bookingDetails', parent.bookingDetails);

  /// `{count} Guest`
  @override
  String countGuest(Object count) => getCustomTranslate(
    'countGuest',
    parent.countGuest(count),
    args: {'count': count},
  );

  /// `{count} Guests`
  @override
  String countGuests(Object count) => getCustomTranslate(
    'countGuests',
    parent.countGuests(count),
    args: {'count': count},
  );

  /// `{count} Ticket`
  @override
  String countTicket(Object count) => getCustomTranslate(
    'countTicket',
    parent.countTicket(count),
    args: {'count': count},
  );

  /// `{count} Tickets`
  @override
  String countTickets(Object count) => getCustomTranslate(
    'countTickets',
    parent.countTickets(count),
    args: {'count': count},
  );

  /// `{count} Child`
  @override
  String countChild(Object count) => getCustomTranslate(
    'countChild',
    parent.countChild(count),
    args: {'count': count},
  );

  /// `{count} Children`
  @override
  String countChildren(Object count) => getCustomTranslate(
    'countChildren',
    parent.countChildren(count),
    args: {'count': count},
  );

  /// `{count} Infant`
  @override
  String countInfant(Object count) => getCustomTranslate(
    'countInfant',
    parent.countInfant(count),
    args: {'count': count},
  );

  /// `{count} Infants`
  @override
  String countInfants(Object count) => getCustomTranslate(
    'countInfants',
    parent.countInfants(count),
    args: {'count': count},
  );

  /// `{count} Animal`
  @override
  String countAnimal(Object count) => getCustomTranslate(
    'countAnimal',
    parent.countAnimal(count),
    args: {'count': count},
  );

  /// `{count} Animals`
  @override
  String countAnimals(Object count) => getCustomTranslate(
    'countAnimals',
    parent.countAnimals(count),
    args: {'count': count},
  );
  ...
  String get bookingDate =>
      getCustomTranslate('bookingDate', parent.bookingDate);

  /// `Booking #{id}`
  @override
  String bookingID(Object id) =>
      getCustomTranslate('bookingID', parent.bookingID(id), args: {'id': id});

  /// `Delete Booking`
  @override
  String get deleteBooking =>
      getCustomTranslate('deleteBooking', parent.deleteBooking);

  /// `Cancel Booking`
  @override
  String get cancelBooking =>
      getCustomTranslate('cancelBooking', parent.cancelBooking);

  /// `Booking Confirmation`
  @override
  String get bookingConfirmation =>
      getCustomTranslate('bookingConfirmation', parent.bookingConfirmation);

  /// `Check-in: {date}`
  @override
  String checkIn(Object date) =>
      getCustomTranslate('checkIn', parent.checkIn(date), args: {'date': date});

  /// `Check-out: {date}`
  @override
  String checkOut(Object date) => getCustomTranslate(
    'checkOut',
    parent.checkOut(date),
    args: {'date': date},
  );

  /// `Event Date: {date}`
  @override
  String eventDate(Object date) => getCustomTranslate(
    'eventDate',
    parent.eventDate(date),
    args: {'date': date},
  );
  ...
  String get sendOrderViaWhatsApp =>
      getCustomTranslate('sendOrderViaWhatsApp', parent.sendOrderViaWhatsApp);

  /// `Your order is received in the system and you can send the same order via WhatsApp.`
  @override
  String get sendOrderViaWhatsAppMsg => getCustomTranslate(
    'sendOrderViaWhatsAppMsg',
    parent.sendOrderViaWhatsAppMsg,
  );

  /// `Oops! We couldn’t open this link.`
  @override
  String get invalidUrl => getCustomTranslate('invalidUrl', parent.invalidUrl);

  /// `Relevance`
  @override
  String get relevance => getCustomTranslate('relevance', parent.relevance);

  /// `Minimum {count} characters required`
  @override
  String minCharacterMsg(Object count) => getCustomTranslate(
    'minCharacterMsg',
    parent.minCharacterMsg(count),
    args: {'count': count},
  );

  /// `No store information available`
  @override
  String get noStoreInformation =>
      getCustomTranslate('noStoreInformation', parent.noStoreInformation);

  /// `Already have an account?`
  @override
  String get alreadyHaveAnAccount =>
      getCustomTranslate('alreadyHaveAnAccount', parent.alreadyHaveAnAccount);

  /// `Rental dates`
  @override
  String get rentalDates =>
      getCustomTranslate('rentalDates', parent.rentalDates);

  /// `Available`
  @override
  String get available => getCustomTranslate('available', parent.available);

  /// `Saved to gallery`
  @override
  String get savedToGallery =>
      getCustomTranslate('savedToGallery', parent.savedToGallery);

  /// `Failed to save image`
  @override
  String get failedToSaveImage =>
      getCustomTranslate('failedToSaveImage', parent.failedToSaveImage);

  /// `Reserve price has been met`
  @override
  String get reservePriceHasBeenMet => getCustomTranslate(
    'reservePriceHasBeenMet',
    parent.reservePriceHasBeenMet,
  );

  /// `Reserve price has not been met`
  @override
  String get reservePriceHasNotBeenMet => getCustomTranslate(
    'reservePriceHasNotBeenMet',
    parent.reservePriceHasNotBeenMet,
  );

  /// `Auction item did not make it to reserve price`
  @override
  String get auctionItemDidNotMakeItToReservePrice => getCustomTranslate(
    'auctionItemDidNotMakeItToReservePrice',
    parent.auctionItemDidNotMakeItToReservePrice,
  );

  /// `This is sealed bid auction.`
  @override
  String get thisIsSealedBidAuction => getCustomTranslate(
    'thisIsSealedBidAuction',
    parent.thisIsSealedBidAuction,
  );

  /// `Failed to create review`
  @override
  String get failedToCreateReview =>
      getCustomTranslate('failedToCreateReview', parent.failedToCreateReview);

  /// `Events Categories`
  @override
  String get eventsCategories =>
      getCustomTranslate('eventsCategories', parent.eventsCategories);

  /// `Service Categories`
  @override
  String get serviceCategories =>
      getCustomTranslate('serviceCategories', parent.serviceCategories);

  /// `Rentals Categories`
  @override
  String get rentalsCategories =>
      getCustomTranslate('rentalsCategories', parent.rentalsCategories);

  /// `Classifieds Categories`
  @override
  String get classifiedsCategories =>
      getCustomTranslate('classifiedsCategories', parent.classifiedsCategories);

  /// `Create Index`
  @override
  String get createIndex =>
      getCustomTranslate('createIndex', parent.createIndex);

  /// `Missing Firestore index detected!`
  @override
  String get missingFirestoreIndexTitle => getCustomTranslate(
    'missingFirestoreIndexTitle',
    parent.missingFirestoreIndexTitle,
  );

  /// `This query requires an index. Please log in to the Firebase console and create the index by clicking the button below. You need to wait a moment for it to be enabled.`
  @override
  String get missingFirestoreIndexDescription => getCustomTranslate(
    'missingFirestoreIndexDescription',
    parent.missingFirestoreIndexDescription,
  );

  /// `Payment cancelled`
  @override
  String get paymentCancelled =>
      getCustomTranslate('paymentCancelled', parent.paymentCancelled);

  /// `Cannot get payment URL`
  @override
  String get cannotGetPaymentURL =>
      getCustomTranslate('cannotGetPaymentURL', parent.cannotGetPaymentURL);

  /// `Media added to the playlist successfully.`
  @override
  String get addMediaToPlaylistSuccess => getCustomTranslate(
    'addMediaToPlaylistSuccess',
    parent.addMediaToPlaylistSuccess,
  );

  /// `Media added to the playlist. {length} new item(s) added.`
  @override
  String addMediaToPlaylistSuccessWithCount(Object length) =>
      getCustomTranslate(
        'addMediaToPlaylistSuccessWithCount',
        parent.addMediaToPlaylistSuccessWithCount(length),
        args: {'length': length},
      );

  /// `Failed to add media to the playlist.`
  @override
  String get addMediaToPlaylistFailed => getCustomTranslate(
    'addMediaToPlaylistFailed',
    parent.addMediaToPlaylistFailed,
  );

  /// `Add Media to Playlist`
  @override
  String get addMediaToPlaylist =>
      getCustomTranslate('addMediaToPlaylist', parent.addMediaToPlaylist);

  /// `Invalid booking.`
  @override
  String get invalidBooking =>
      getCustomTranslate('invalidBooking', parent.invalidBooking);

  /// `Booking not found.`
  @override
  String get bookingNotFound =>
      getCustomTranslate('bookingNotFound', parent.bookingNotFound);

  /// `Failed to delete the booking.`
  @override
  String get deleteBookingFailed =>
      getCustomTranslate('deleteBookingFailed', parent.deleteBookingFailed);

  /// `Failed to cancel the booking.`
  @override
  String get cancelBookingFailed =>
      getCustomTranslate('cancelBookingFailed', parent.cancelBookingFailed);

  /// `Total cost`
  @override
  String get totalCost => getCustomTranslate('totalCost', parent.totalCost);

  /// `Final cost`
  @override
  String get finalCost => getCustomTranslate('finalCost', parent.finalCost);

  /// `Coupon removed successfully`
  @override
  String get couponRemove =>
      getCustomTranslate('couponRemove', parent.couponRemove);

  /// `You saved {price}`
  @override
  String youSaved(Object price) => getCustomTranslate(
    'youSaved',
    parent.youSaved(price),
    args: {'price': price},
  );

  /// `Quantity must be greater than zero`
  @override
  String get quantityMustBeGreaterThanZero => getCustomTranslate(
    'quantityMustBeGreaterThanZero',
    parent.quantityMustBeGreaterThanZero,
  );

  /// `The maximum quantity allowed in the cart is {maxQuantity}`
  @override
  String maximumQuantityAllowed(Object maxQuantity) => getCustomTranslate(
    'maximumQuantityAllowed',
    parent.maximumQuantityAllowed(maxQuantity),
    args: {'maxQuantity': maxQuantity},
  );

  /// `Please adjust your cart before proceeding to checkout.`
  @override
  String get pleaseAdjustYourCart =>
      getCustomTranslate('pleaseAdjustYourCart', parent.pleaseAdjustYourCart);

  /// `Frequently Asked Questions`
  @override
  String get frequentlyAskedQuestions => getCustomTranslate(
    'frequentlyAskedQuestions',
    parent.frequentlyAskedQuestions,
  );

  /// `Minimum stay is {day} days`
  @override
  String minStayDays(Object day) => getCustomTranslate(
    'minStayDays',
    parent.minStayDays(day),
    args: {'day': day},
  );

  /// `Maximum {count} guests allowed`
  @override
  String maximumGuestsAllowed(Object count) => getCustomTranslate(
    'maximumGuestsAllowed',
    parent.maximumGuestsAllowed(count),
    args: {'count': count},
  );

  /// `Minimum {count} guest(s) required`
  @override
  String minimumGuestsRequired(Object count) => getCustomTranslate(
    'minimumGuestsRequired',
    parent.minimumGuestsRequired(count),
    args: {'count': count},
  );

  /// `Maximum {count} children allowed`
  @override
  String maximumChildrenAllowed(Object count) => getCustomTranslate(
    'maximumChildrenAllowed',
    parent.maximumChildrenAllowed(count),
    args: {'count': count},
  );
  ...
  String get verifiedListing =>
      getCustomTranslate('verifiedListing', parent.verifiedListing);

  /// `Instant Booking`
  @override
  String get instantBooking =>
      getCustomTranslate('instantBooking', parent.instantBooking);

  /// `Your short message to the listing owner (optional)`
  @override
  String get messageToListingOwner =>
      getCustomTranslate('messageToListingOwner', parent.messageToListingOwner);

  /// `Have a coupon?`
  @override
  String get haveACoupon =>
      getCustomTranslate('haveACoupon', parent.haveACoupon);

  /// `No membership plans available`
  @override
  String get noMembershipPlans =>
      getCustomTranslate('noMembershipPlans', parent.noMembershipPlans);

  /// `Select product tags`
  @override
  String get selectProductTags =>
      getCustomTranslate('selectProductTags', parent.selectProductTags);

  /// `Select product brands`
  @override
  String get selectProductBrands =>
      getCustomTranslate('selectProductBrands', parent.selectProductBrands);

  /// `Add new attribute`
  @override
  String get addNewAttribute =>
      getCustomTranslate('addNewAttribute', parent.addNewAttribute);

  /// `Camera`
  @override
  String get camera => getCustomTranslate('camera', parent.camera);

  /// `Network`
  @override
  String get network => getCustomTranslate('network', parent.network);

  /// `Calendar View`
  @override
  String get calendarView =>
      getCustomTranslate('calendarView', parent.calendarView);

  /// `Press and hold a day to see the full price`
  @override
  String get pressOnDayToSeeFullPrice => getCustomTranslate(
    'pressOnDayToSeeFullPrice',
    parent.pressOnDayToSeeFullPrice,
  );

  /// `Ship to a different address?`
  @override
  String get shipToADifferentAddress => getCustomTranslate(
    'shipToADifferentAddress',
    parent.shipToADifferentAddress,
  );

  /// `No checkout fields available`
  @override
  String get noCheckoutFieldsAvailable => getCustomTranslate(
    'noCheckoutFieldsAvailable',
    parent.noCheckoutFieldsAvailable,
  );

  /// `Failed to load checkout fields`
  @override
  String get failedToLoadCheckoutFields => getCustomTranslate(
    'failedToLoadCheckoutFields',
    parent.failedToLoadCheckoutFields,
  );

  /// `Continue as Guest`
  @override
  String get continueAsGuest =>
      getCustomTranslate('continueAsGuest', parent.continueAsGuest);

  /// `Order extra`
  @override
  String get orderExtra => getCustomTranslate('orderExtra', parent.orderExtra);

  /// `Min {value}`
  @override
  String minValue(Object value) => getCustomTranslate(
    'minValue',
    parent.minValue(value),
    args: {'value': value},
  );

  /// `Max {value}`
  @override
  String maxValue(Object value) => getCustomTranslate(
    'maxValue',
    parent.maxValue(value),
    args: {'value': value},
  );

  /// `Sale to date cannot be earlier than sale from date.`
  @override
  String get saleToDateCannotBeEarlier => getCustomTranslate(
    'saleToDateCannotBeEarlier',
    parent.saleToDateCannotBeEarlier,
  );

  /// `Catalog visibility`
  @override
  String get catalogVisibility =>
      getCustomTranslate('catalogVisibility', parent.catalogVisibility);

  /// `This setting determines which shop pages products will be listed on.`
  @override
  String get catalogVisibilityTooltip => getCustomTranslate(
    'catalogVisibilityTooltip',
    parent.catalogVisibilityTooltip,
  );

  /// `Shop and search results`
  @override
  String get shopAndSearchResults =>
      getCustomTranslate('shopAndSearchResults', parent.shopAndSearchResults);

  /// `Shop only`
  @override
  String get shopOnly => getCustomTranslate('shopOnly', parent.shopOnly);

  /// `Search results only`
  @override
  String get searchResultsOnly =>
      getCustomTranslate('searchResultsOnly', parent.searchResultsOnly);

  /// `Hidden`
  @override
  String get hidden => getCustomTranslate('hidden', parent.hidden);

  /// `Please select delivery time`
  @override
  String get pleaseSelectDeliveryTime => getCustomTranslate(
    'pleaseSelectDeliveryTime',
    parent.pleaseSelectDeliveryTime,
  );

  /// `Select a time slot`
  @override
  String get selectTimeSlot =>
      getCustomTranslate('selectTimeSlot', parent.selectTimeSlot);

  /// `As soon as possible`
  @override
  String get asSoonAsPossible =>
      getCustomTranslate('asSoonAsPossible', parent.asSoonAsPossible);

  /// `Today`
  @override
  String get today => getCustomTranslate('today', parent.today);

  /// `The username/email or password is incorrect.`
  @override
  String get userNameOrPasswordIncorrect => getCustomTranslate(
    'userNameOrPasswordIncorrect',
    parent.userNameOrPasswordIncorrect,
  );

  /// `Failed to send OTP!`
  @override
  String get failedToSendOtp =>
      getCustomTranslate('failedToSendOtp', parent.failedToSendOtp);

  /// `Copy the reset link from your email and paste it below`
  @override
  String get copyResetLinkFromEmail => getCustomTranslate(
    'copyResetLinkFromEmail',
    parent.copyResetLinkFromEmail,
  );

  /// `Reset link`
  @override
  String get resetLink => getCustomTranslate('resetLink', parent.resetLink);

  /// `Paste reset link from email`
  @override
  String get pasteResetLink =>
      getCustomTranslate('pasteResetLink', parent.pasteResetLink);
}
