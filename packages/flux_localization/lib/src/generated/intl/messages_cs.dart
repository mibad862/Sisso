...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Média byla přidána do playlistu. Přidáno ${length} nových položek.";

  static String m3(attribute) => "Jakýkoliv ${attribute}";

  static String m4(point) => "Vaše dostupné body: ${point}";

  static String m5(name) => "Úspěšně podána nabídka na \'${name}\'";

  static String m6(id) => "Rezervace č. ${id}";

  static String m7(date) => "Rezervace požadována dne: ${date}";

  static String m8(amount) => "Kupte nyní za ${amount}";
  ...
  static String m11(currency) => "Měna změněna na ${currency}";

  static String m12(number) => "Zbývá znaků: ${number}";

  static String m13(date) => "Check-in: ${date}";

  static String m14(date) => "Check-out: ${date}";

  static String m15(priceRate, pointRate) => "${priceRate} = ${pointRate} bodů";

  static String m16(count) => "${count} zvíře";

  static String m17(count) => "${count} zvířat";

  static String m18(count) => "${count} dítě";

  static String m19(count) => "${count} dětí";

  static String m20(count) => "${count} host";

  static String m21(count) => "${count} hostů";

  static String m22(count) => "${count} kojenec";

  static String m23(count) => "${count} kojenců";

  static String m24(count) => "${count} položka";

  static String m25(count) => "${count} položek";

  static String m26(count) => "${count} položka";

  static String m27(count) => "${count} položek";

  static String m28(count) => "${count} vstupenka";

  static String m29(count) => "${count} vstupenky";

  static String m30(country) => "Země ${country} není podporována";

  static String m31(currency) => "Měna ${currency} není podporována";

  static String m32(currency) =>
      "Měna ${currency} není podporována vaším účtem Razorpay. Kontaktujte prosím podporu pro povolení mezinárodních plateb nebo změňte na podporovanou měnu.";

  static String m33(total) => "~${total} km";

  static String m34(timeLeft) => "Končí za ${timeLeft}";

  static String m35(captcha) => "Pro potvrzení zadejte ${captcha}:";

  static String m36(message) => "Chyba: ${message}";

  static String m37(message) => "Chyba: ${message}";

  static String m38(error) => "Došlo k chybě: ${error}";

  static String m39(date) => "Datum akce: ${date}";

  static String m40(time) => "Končí za ${time}";
  ...
  static String m46(count) => "Povolen maximum ${count} dětí";

  static String m47(size) => "Maximální velikost souboru: ${size} MB";

  static String m48(count) => "Povoleno maximálně ${count} hostů";

  static String m49(maxQuantity) =>
      "Maximální povolené množství v košíku je ${maxQuantity}";
  ...
  static String m52(count) => "Je vyžadováno minimálně ${count} znaků";
  ...
  static String m54(day) => "Minimální délka pobytu je ${day} dní";

  static String m55(amount) =>
      "Tento kupón vyžaduje minimální nákup v hodnotě ${amount}.";

  static String m56(value) => "Minimální transakce: ${value}";

  static String m57(value) => "Min. ${value}";

  static String m58(count) => "Vyžadováno minimálně ${count} hostů";

  static String m59(store) => "Další od ${store}";

  static String m60(number) => "Musí být zakoupeno v množství po ${number}";

  static String m61(itemCount) => "Položky: ${itemCount}";

  static String m62(amount) => "Zaplatit ${amount}";

  static String m63(date) => "Platba do: ${date}";

  static String m64(name) => "Produkt ${name} byl přidán do košíku";

  static String m65(total) => "Množství: ${total}";

  static String m66(name) => "Přijaty peníze od uživatele ${name}";

  static String m67(count) =>
      "Chcete odebrat položky (celkem ${count}) ze seznamu přání?";

  static String m68(percent) => "Sleva ${percent}%";

  static String m69(keyword, count) => "${keyword} (${count} položka)";

  static String m70(keyword, count) => "${keyword} (${count} položek)";

  static String m71(totalCartQuantity) =>
      "Nákupní košík, ${totalCartQuantity} položek";

  static String m72(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m73(price) => "Začíná od ${price}";

  static String m74(fieldName) => "Pole ${fieldName} je povinné";

  static String m75(total) => "${total} produktů";

  static String m76(name) => "Převést peníze uživateli ${name}";

  static String m77(price) => "Až do ${price}";

  static String m78(amount) => "Použijte ${amount} bodů";
  ...
  static String m80(time) => "Platné do: ${time}";

  static String m81(date) => "Platné do ${date}";

  static String m82(number) => "Verze ${number}";

  static String m83(balance) => "Zůstatek v peněžence: ${balance}";

  static String m84(message) => "Upozornění: ${message}";
  ...
  static String m86(week) => "Týden ${week}";

  static String m87(name) => "Vítejte, ${name}";

  static String m88(count) => "Vybíráte položky (celkem ${count})";

  static String m89(type) => "Splnili jste ${type}";

  static String m90(point) => "Máte ${point} bodů";

  static String m91(price) => "Ušetřili jste ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Zabezpečení účtu"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Pravidelná změna hesla pomáhá chránit váš účet",
    ),
    ...
    "addressAddedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Adresa byla úspěšně přidána",
    ),
    "addressManagement": MessageLookupByLibrary.simpleMessage("Správa adres"),
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Přidávejte, upravujte doručovací adresy",
    ),
    ...
    "animals": MessageLookupByLibrary.simpleMessage("Zvířata"),
    "anyAttr": m3,
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Opravdu chcete tento chat ukončit?",
    ),
    ...
    "asSoonAsPossible": MessageLookupByLibrary.simpleMessage("Co nejdříve"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Předmět aukce nedosáhl minimální ceny",
        ),
    ...
    "available": MessageLookupByLibrary.simpleMessage("Dostupné"),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Datum rezervace"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Rezervace byla úspěšně smazána",
    ),
    "bookingDetails": MessageLookupByLibrary.simpleMessage("Detaily rezervace"),
    "bookingHistory": MessageLookupByLibrary.simpleMessage(
      "Historie rezervací",
    ),
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("Místo rezervace"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Zrušit rezervaci"),
    ...
    "canceledReversal": MessageLookupByLibrary.simpleMessage("Zrušení storna"),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Nelze změnit heslo. Zkuste to prosím znovu.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Nelze vytvořit fakturu pro Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Nelze vytvořit objednávku pro Razorpay",
    ),
    ...
    "catalogVisibility": MessageLookupByLibrary.simpleMessage(
      "Viditelnost katalogu",
    ),
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Toto nastavení určuje, na kterých stránkách obchodu budou produkty uvedeny.",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Aktualizujte bezpečnostní heslo",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Reklamace platby"),
    "chat": MessageLookupByLibrary.simpleMessage("Chat"),
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Chat byl ukončen. Zahajte prosím nový chat.",
    ),
    "chatListScreen": MessageLookupByLibrary.simpleMessage("Zprávy"),
    "chatNow": MessageLookupByLibrary.simpleMessage("Chatovat nyní"),
    ...
    "children": MessageLookupByLibrary.simpleMessage("Děti"),
    "childrenDesc": MessageLookupByLibrary.simpleMessage("Věk 2–12"),
    ...
    "copyResetLinkFromEmail": MessageLookupByLibrary.simpleMessage(
      "Zkopírujte odkaz pro resetování z e-mailu a vložte jej níže",
    ),
    ...
    "countTicket": m28,
    "countTickets": m29,
    "countries": MessageLookupByLibrary.simpleMessage("země"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Vytvořit index"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Výchozí adresa"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Výchozí adresa byla úspěšně aktualizována",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Výchozí"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Smazat rezervaci"),
    ...
    "deliveryTime": MessageLookupByLibrary.simpleMessage("Čas doručení"),
    "denied": MessageLookupByLibrary.simpleMessage("Zamítnuto"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Zobrazované jméno je automaticky generováno z křestního jména a příjmení",
    ),
    "distance": m33,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Upravit adresu"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Ukončit chat"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Chyba"),
    ...
    "failed": MessageLookupByLibrary.simpleMessage("Neúspěšné"),
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Nepodařilo se vytvořit recenzi",
    ),
    ...
    "failedToLoadCheckoutFields": MessageLookupByLibrary.simpleMessage(
      "Nepodařilo se načíst pole pokladny",
    ),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Konečná cena"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Získat vstupenku"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Máte slevový kupón?"),
    ...
    "infants": MessageLookupByLibrary.simpleMessage("kojenci"),
    "infantsDesc": MessageLookupByLibrary.simpleMessage("Pod 2"),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Jejda! Tento odkaz se nepodařilo otevřít.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("je vyžadováno"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Živý chat"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Vaše krátká zpráva pro vlastníka nabídky (volitelné)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Tento dotaz vyžaduje index. Přihlaste se do Firebase konzole a vytvořte index kliknutím na tlačítko níže. Musíte chvíli počkat, než bude index povolen.",
    ),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("Jméno je povinné"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Nové heslo"),
    ...
    "noCheckoutFieldsAvailable": MessageLookupByLibrary.simpleMessage(
      "K dispozici žádná pole pro dokončení objednávky",
    ),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Žádné připojení k internetu. Pro pokračování v nákupu se připojte.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "V této objednávce nebyly nalezeny žádné produkty",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Informace o obchodě nejsou k dispozici",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Nejste přihlášeni, chat bude ukončen, pokud odejdete.",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("Pozastaveno"),
    ...
    "orderExtra": MessageLookupByLibrary.simpleMessage("Přidat extra"),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Původní adresa nebyla nalezena",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Jiná adresa"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Tipy pro heslo:"),
    "passwordsDoNotMatch": MessageLookupByLibrary.simpleMessage(
      "Hesla se neshodují",
    ),
    "pasteResetLink": MessageLookupByLibrary.simpleMessage(
      "Vložte odkaz pro resetování z e-mailu",
    ),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("Čeká na platbu"),
    "pendingReviews": MessageLookupByLibrary.simpleMessage("Čekající recenze"),
    "personalInformation": MessageLookupByLibrary.simpleMessage("Osobní údaje"),
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Aktualizujte jméno, telefonní číslo",
    ),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Nejprve prosím přidejte adresu",
    ),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Před pokračováním k pokladně upravte prosím svůj košík.",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Povolte prosím přístup k poloze",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Zkontrolujte prosím následující problémy:",
    ),
    ...
    "pleaseEnterCurrentPassword": MessageLookupByLibrary.simpleMessage(
      "Zadejte prosím své současné heslo",
    ),
    "pleaseEnterFirstName": MessageLookupByLibrary.simpleMessage(
      "Zadejte prosím křestní jméno",
    ),
    ...
    "pressOnDayToSeeFullPrice": MessageLookupByLibrary.simpleMessage(
      "Klepněte a podržte den pro zobrazení plné ceny",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Zpracováno"),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produkt není připraven k opětovnému objednání",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Varianty produktu nejsou k dispozici",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Nabídka"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Vráceno"),
    "refunds": MessageLookupByLibrary.simpleMessage("Vrácení peněz"),
    "regions": MessageLookupByLibrary.simpleMessage("Regiony"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Relevantnost"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Termíny pronájmu"),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "Minimální cena byla dosažena",
    ),
    "reservePriceHasNotBeenMet": MessageLookupByLibrary.simpleMessage(
      "Minimální cena nebyla dosažena",
    ),
    "reset": MessageLookupByLibrary.simpleMessage("Resetovat"),
    "resetLink": MessageLookupByLibrary.simpleMessage("Odkaz pro resetování"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Stornováno"),
    ...
    "sale": m68,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Sleva od data"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Akční cena"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Sleva do data"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Datum ukončení slevy nemůže být dřívější než datum zahájení slevy.",
    ),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Uložené adresy"),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Naplánovat slevu"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Hledat země..."),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Odeslat objednávku přes WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Vaše objednávka byla přijata do systému a můžete ji odeslat také přes WhatsApp.",
    ),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Člen Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Mělo by obsahovat čísla a speciální znaky",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• Mělo by obsahovat velká i malá písmena",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Zahájit chat"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Toto je aukce s tajnou nabídkou.",
    ),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Tipy:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Nejlepší značky"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Celková cena"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Typy"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Nedefinováno"),
    ...
    "updateInformationSuccess": MessageLookupByLibrary.simpleMessage(
      "Informace byly úspěšně aktualizovány",
    ),
    ...
    "updateYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Aktualizujte informace o adrese",
    ),
    ...
    "userNameOrPasswordIncorrect": MessageLookupByLibrary.simpleMessage(
      "Uživatelské jméno/e-mail nebo heslo je nesprávné.",
    ),
    ...
    "validUntil": m80,
    "validUntilDate": m81,
    "validationError": MessageLookupByLibrary.simpleMessage("Chyba ověření"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Používejte dvoupísmenné kódy států (CA, NY, TX)\n• Používejte dvoupísmenné kódy zemí (US, CA, GB)\n• Zkontrolujte formát PSČ\n• Ujistěte se, že jsou vyplněna všechna povinná pole",
    ),
    ...
    "verifiedListing": MessageLookupByLibrary.simpleMessage("Ověřený inzerát"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Zneplatněno"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage(
      "Napište svůj titulek (volitelné)",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Pro zobrazení adres se musíte přihlásit",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Vaše hodnocení"),
