...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) => "メディアがプレイリストに追加されました。${length}件の新しいアイテムが追加されました。";

  static String m3(attribute) => "任意の${attribute}";

  static String m4(point) => "利用可能なポイント：${point}";

  static String m5(name) => "「${name}」への入札が完了しました";

  static String m6(id) => "予約番号：${id}";

  static String m7(date) => "予約リクエスト日：${date}";

  static String m8(amount) => "今すぐ購入 ${amount}";

  static String m9(author) => "作者：${author}";

  static String m10(fieldName) => "${fieldName}は3文字以上で入力してください";

  static String m11(currency) => "通貨を${currency}に変更しました";

  static String m12(number) => "残り${number}文字";

  static String m13(date) => "チェックイン：${date}";

  static String m14(date) => "チェックアウト：${date}";

  static String m15(priceRate, pointRate) => "${priceRate} = ${pointRate}ポイント";

  static String m16(count) => "${count} 匹のペット";

  static String m17(count) => "${count} 匹のペット";

  static String m18(count) => "${count} 人の子供";

  static String m19(count) => "${count} 人の子供";

  static String m20(count) => "${count}名様";

  static String m21(count) => "${count}名様";

  static String m22(count) => "${count} 人の乳幼児";

  static String m23(count) => "${count} 人の乳幼児";

  static String m24(count) => "${count}個のアイテム";

  static String m25(count) => "${count}個のアイテム";

  static String m26(count) => "${count}個の商品";

  static String m27(count) => "${count}個の商品";

  static String m28(count) => "${count}枚のチケット";

  static String m29(count) => "${count}枚のチケット";

  static String m30(country) => "${country}はサポートされていません";

  static String m31(currency) => "${currency}はサポートされていません";

  static String m32(currency) =>
      "通貨${currency}は、お使いのRazorpayアカウントではサポートされていません。国際決済の有効化や対応通貨への変更については、サポートまでご連絡ください。";

  static String m33(total) => "${total}km";

  static String m34(timeLeft) => "残り${timeLeft}";

  static String m35(captcha) => "${captcha}を入力して確認してください";

  static String m36(message) => "エラー：${message}";

  static String m37(message) => "エラー：${message}";

  static String m38(error) => "エラーが発生しました: ${error}";

  static String m39(date) => "イベント日：${date}";

  static String m40(time) => "有効期限：${time}";

  static String m41(total) => "${total}km以上";

  static String m42(currentBalance) => "ウォレット残高が不足しています（残高：${currentBalance}）";

  static String m43(message) => "データの取得中に問題が発生しました。管理者に連絡してください：${message}";

  static String m44(currency, amount) => "この支払いの上限額は${currency} ${amount}です";

  static String m45(value) => "最大 ${value}";

  static String m46(count) => "子供は最大 ${count} 人までです";

  static String m47(size) => "最大ファイルサイズ：${size} MB";

  static String m48(count) => "最大${count}名まで宿泊可能です";

  static String m49(maxQuantity) => "カートに追加できる最大数量は${maxQuantity}です";

  static String m50(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m51(currency, amount) => "この支払いの最低額は${currency} ${amount}です";

  static String m52(count) => "最低${count}文字が必要です";

  static String m53(storeName, minOrderAmount) =>
      " ${storeName} の最低注文金額は ${minOrderAmount}です。このストアからさらに商品を追加してください。";

  static String m54(day) => "最低宿泊日数は${day}日です";

  static String m55(amount) => "このクーポンは最低 ${amount}の購入が必要です。";

  static String m56(value) => "最小取引: ${value}";

  static String m57(value) => "最小 ${value}";

  static String m58(count) => "最低${count}名の宿泊が必要です";

  static String m59(store) => "${store}の他の商品";

  static String m60(number) => "${number}個単位で購入する必要があります";

  static String m61(itemCount) => "${itemCount}点";

  static String m62(amount) => "${amount}を支払う";

  static String m63(date) => "支払期日：${date}";

  static String m64(name) => "${name}をカートに追加しました";

  static String m65(total) => "数量：${total}";

  static String m66(name) => "${name}から入金がありました";

  static String m67(count) => "${count}個の商品をお気に入りから削除しますか？";

  static String m68(percent) => "セール ${percent}%オフ";

  static String m69(keyword, count) => "${keyword}（${count}件）";

  static String m70(keyword, count) => "${keyword}（${count}件）";

  static String m71(totalCartQuantity) => "カート内の商品：${totalCartQuantity}点";

  static String m72(numberOfUnitsSold) => "売れた数：${numberOfUnitsSold}";

  static String m73(price) => "${price}から開始";

  static String m74(fieldName) => "${fieldName}は必須項目です";

  static String m75(total) => "商品数：${total}";

  static String m76(name) => "${name}に送金";

  static String m77(price) => "最大${price}まで";

  static String m78(amount) => " ${amount} ポイントを使用する";

  static String m79(maxPointDiscount, maxPriceDiscount) =>
      "この注文で最大${maxPointDiscount}ポイントを使用すると、${maxPriceDiscount}の割引が適用されます。";

  static String m80(time) => "有効期限: ${time}";

  static String m81(date) => "${date}まで有効";

  static String m82(number) => "バージョン ${number}";

  static String m83(balance) => "ウォレット残高：${balance}";
  ...
  static String m86(week) => "週 ${week}";

  static String m87(name) => "ようこそ、${name}さん";

  static String m88(count) => "${count}個の商品を選択中";

  static String m89(type) => " ${type}に合格しました";

  static String m90(point) => "${point}ポイントあります";

  static String m91(price) => "${price}節約できました";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("アカウントのセキュリティ"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "定期的なパスワード変更はアカウント保護に役立ちます",
    ),
    ...
    "addNewAttribute": MessageLookupByLibrary.simpleMessage("新しい属性を追加"),
    ...
    "addedToCart": MessageLookupByLibrary.simpleMessage("カートに追加しました"),
    ...
    "addressManagement": MessageLookupByLibrary.simpleMessage("住所管理"),
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "配送先住所の追加・編集",
    ),
    "addressNotFound": MessageLookupByLibrary.simpleMessage("住所が見つかりません"),
    ...
    "animals": MessageLookupByLibrary.simpleMessage("ペット"),
    "anyAttr": m3,
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("承認済み - 支払い済み"),
    "approvedRequests": MessageLookupByLibrary.simpleMessage("承認済みのリクエスト"),
    "approvedUnpaid": MessageLookupByLibrary.simpleMessage("承認済み - 未払い"),
    ...
    "asSoonAsPossible": MessageLookupByLibrary.simpleMessage("できるだけ早く"),
    "assigned": MessageLookupByLibrary.simpleMessage("割り当て済み"),
    "atLeast8Characters": MessageLookupByLibrary.simpleMessage("・8文字以上"),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage("オークション品は最低落札価格に達しませんでした"),
    ...
    "bookingConfirmation": MessageLookupByLibrary.simpleMessage("予約確認"),
    "bookingDate": MessageLookupByLibrary.simpleMessage("予約日"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "予約が正常に削除されました",
    ),
    "bookingDetails": MessageLookupByLibrary.simpleMessage("予約詳細"),
    "bookingHistory": MessageLookupByLibrary.simpleMessage("予約履歴"),
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("予約場所"),
    "bookingNotFound": MessageLookupByLibrary.simpleMessage("予約が見つかりません。"),
    ...
    "calendarView": MessageLookupByLibrary.simpleMessage("カレンダー表示"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("予約をキャンセル"),
    ...
    "canceledReversal": MessageLookupByLibrary.simpleMessage("キャンセルされた返金"),
    ...
    "catalogVisibility": MessageLookupByLibrary.simpleMessage("カタログの表示設定"),
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "この設定では、どのショップページに商品を表示するかを決定します。",
    ),
    ...
    "childrenDesc": MessageLookupByLibrary.simpleMessage("2〜12歳"),
    ...
    "confirmNewPassword": MessageLookupByLibrary.simpleMessage("新しいパスワードの確認"),
    ...
    "contactInformation": MessageLookupByLibrary.simpleMessage("連絡先情報"),
    "content": MessageLookupByLibrary.simpleMessage("コンテンツ"),
    "continueAsGuest": MessageLookupByLibrary.simpleMessage("ゲストとして続行"),
    ...
    "continueToPreview": MessageLookupByLibrary.simpleMessage("プレビューへ進む"),
    ...
    "copyResetLinkFromEmail": MessageLookupByLibrary.simpleMessage(
      "メールからリセットリンクをコピーして、以下に貼り付けてください",
    ),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage("クーポンが正常に削除されました"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("インデックスを作成"),
    ...
    "currentPasswordSection": MessageLookupByLibrary.simpleMessage("現在のパスワード"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("デフォルト住所"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "デフォルト住所が正常に更新されました",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("デフォルト"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("予約を削除"),
    ...
    "deliveryTime": MessageLookupByLibrary.simpleMessage("配達時間"),
    "denied": MessageLookupByLibrary.simpleMessage("拒否されました"),
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("住所を編集"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("チャットを終了"),
    ...
    "eventsCategories": MessageLookupByLibrary.simpleMessage("イベントカテゴリ"),
    "expectedDeliveryDate": MessageLookupByLibrary.simpleMessage("配送予定日"),
    "expectedDeliveryTime": MessageLookupByLibrary.simpleMessage("配達予定時刻"),
    ...
    "failedToLoadCheckoutFields": MessageLookupByLibrary.simpleMessage(
      "チェックアウト項目の読み込みに失敗しました",
    ),
    "failedToLoadImage": MessageLookupByLibrary.simpleMessage("画像の読み込みに失敗しました"),
    "failedToSaveImage": MessageLookupByLibrary.simpleMessage("画像の保存に失敗しました"),
    "failedToSendOtp": MessageLookupByLibrary.simpleMessage("OTPの送信に失敗しました！"),
    ...
    "featureImage": MessageLookupByLibrary.simpleMessage("おすすめ画像"),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("最終金額"),
    ...
    "frequentlyAskedQuestions": MessageLookupByLibrary.simpleMessage("よくある質問"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("チケットを取得"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("クーポンをお持ちですか？"),
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "ご質問がありますか？お気軽にご連絡ください！",
    ),
    ...
    "infants": MessageLookupByLibrary.simpleMessage("乳幼児"),
    "infantsDesc": MessageLookupByLibrary.simpleMessage("2歳未満"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("即時予約"),
    ...
    "invalidBooking": MessageLookupByLibrary.simpleMessage("無効な予約です。"),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("必須項目です"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("ライブチャット"),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "このクエリにはインデックスが必要です。Firebaseコンソールにログインし、下のボタンをクリックしてインデックスを作成してください。有効になるまで少しお待ちください。",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Firestoreインデックスが見つかりません！",
    ),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("名前は必須です"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("新しいパスワード"),
    ...
    "noAddressesFound": MessageLookupByLibrary.simpleMessage("住所が見つかりません"),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("表示名がありません"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ インターネット接続がありません。再接続してショッピングを続けてください。",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage("店舗情報がありません"),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "ログインしていません。終了するとチャットは期限切れになります。",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("保留中"),
    ...
    "orderExtra": MessageLookupByLibrary.simpleMessage("追加注文"),
    ...
    "otherAddress": MessageLookupByLibrary.simpleMessage("その他の住所"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("パスワードのヒント："),
    "passwordsDoNotMatch": MessageLookupByLibrary.simpleMessage("パスワードが一致しません"),
    "pasteResetLink": MessageLookupByLibrary.simpleMessage("メールからリセットリンクを貼り付け"),
    ...
    "paymentCancelled": MessageLookupByLibrary.simpleMessage("支払いがキャンセルされました"),
    ...
    "pendingPayment": MessageLookupByLibrary.simpleMessage("支払い待ち"),
    ...
    "pleaseEnterFirstName": MessageLookupByLibrary.simpleMessage("名を入力してください"),
    "pleaseEnterLastName": MessageLookupByLibrary.simpleMessage("姓を入力してください"),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("処理済み"),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("見積もり"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("返金済み"),
    "refunds": MessageLookupByLibrary.simpleMessage("返金"),
    "regions": MessageLookupByLibrary.simpleMessage("地域"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("関連性"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("レンタル日程"),
    "rentalsCategories": MessageLookupByLibrary.simpleMessage("レンタルカテゴリ"),
    ...
    "resetLink": MessageLookupByLibrary.simpleMessage("リセットリンク"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("返金処理済み"),
    ...
    "sale": m68,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("セール開始日"),
    "salePrice": MessageLookupByLibrary.simpleMessage("セール価格"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("セール終了日"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "セール終了日はセール開始日より前に設定できません。",
    ),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("保存済み住所"),
    "savedToGallery": MessageLookupByLibrary.simpleMessage("ギャラリーに保存しました"),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("セールを設定"),
    "search": MessageLookupByLibrary.simpleMessage("検索"),
    "searchByCountryNameOrDialCode": MessageLookupByLibrary.simpleMessage(
      "国名または国番号で検索",
    ),
    "searchByName": MessageLookupByLibrary.simpleMessage("名前で検索..."),
    "searchCountries": MessageLookupByLibrary.simpleMessage("国を検索..."),
    ...
    "searchResultsOnly": MessageLookupByLibrary.simpleMessage("検索結果のみ"),
    ...
    "selectProductBrands": MessageLookupByLibrary.simpleMessage("商品ブランドを選択"),
    "selectProductTags": MessageLookupByLibrary.simpleMessage("商品タグを選択"),
    ...
    "selectTimeSlot": MessageLookupByLibrary.simpleMessage("時間枠を選択"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "ご注文はシステムに受け付けられました。同じ注文をWhatsAppでも送信できます。",
    ),
    ...
    "serviceCategories": MessageLookupByLibrary.simpleMessage("サービスカテゴリ"),
    ...
    "shopAndSearchResults": MessageLookupByLibrary.simpleMessage("ショップと検索結果"),
    "shopEmail": MessageLookupByLibrary.simpleMessage("店舗メール"),
    "shopName": MessageLookupByLibrary.simpleMessage("店舗名"),
    "shopOnly": MessageLookupByLibrary.simpleMessage("ショップのみ"),
    ...
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopifyメンバー"),
    ...
    "submitQuoteRequest": MessageLookupByLibrary.simpleMessage("見積もり依頼を送信"),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("ヒント："),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("トップブランド"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("合計金額"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("種類"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("住所を更新"),
    "updateFailed": MessageLookupByLibrary.simpleMessage("アップデートに失敗しました"),
    "updateInfo": MessageLookupByLibrary.simpleMessage("情報を更新"),
    "updateInformation": MessageLookupByLibrary.simpleMessage("情報を更新する"),
    ...
    "validUntil": m80,
    "validUntilDate": m81,
    "validationError": MessageLookupByLibrary.simpleMessage("入力内容に誤りがあります"),
    ...
    "verifiedListing": MessageLookupByLibrary.simpleMessage("認証済み掲載"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("無効化されました"),
    ...
    "writeTitleOptional": MessageLookupByLibrary.simpleMessage("タイトルを入力（任意）"),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("あなたの評価"),
