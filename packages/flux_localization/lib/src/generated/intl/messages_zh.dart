...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) => "媒体已添加到播放列表。新增 ${length} 个项目。";
  ...
  static String m10(fieldName) => "${fieldName}不能少于3个字符。";

  static String m11(currency) => "已将货币更改为${currency}";
  ...
  static String m16(count) => "${count} 只宠物";

  static String m17(count) => "${count} 只宠物";

  static String m18(count) => "${count} 位儿童";

  static String m19(count) => "${count} 位儿童";

  static String m20(count) => "${count} 位宾客";

  static String m21(count) => "${count} 位宾客";

  static String m22(count) => "${count} 位婴儿";

  static String m23(count) => "${count} 位婴儿";

  static String m24(count) => "${count}项";

  static String m25(count) => "${count}个项目";
  ...
  static String m32(currency) =>
      "您的 Razorpay 账户不支持 ${currency} 货币。请联系支持以启用国际支付，或更改为支持的货币。";

  static String m33(total) => "约${total}公里";

  static String m34(timeLeft) => "剩余 ${timeLeft}";

  static String m35(captcha) => "输入${captcha}进行确认：";
  ...
  static String m60(number) => "必须按${number}件为单位购买";
  ...
  static String m64(name) => "已将${name}添加到购物车";

  static String m65(total) => "数量：${total}";

  static String m66(name) => "已收到来自${name}的款项";

  static String m67(count) => "是否要从心愿单中移除${count}件商品？";

  static String m68(percent) => "优惠 ${percent}%";

  static String m69(keyword, count) => "${keyword}（${count}项）";

  static String m70(keyword, count) => "${keyword}（${count}项）";
  ...
  static String m75(total) => "${total} 个商品";
  ...
  static String m85(defaultCurrency) => "当前选择的货币不支持钱包功能，请改为${defaultCurrency}";

  static String m86(week) => "第 ${week} 周";

  static String m87(name) => "欢迎，${name}";

  static String m88(count) => "您已选择${count}个商品";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "animals": MessageLookupByLibrary.simpleMessage("宠物"),
    "anyAttr": m3,
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage("您确定要结束此聊天吗？"),
    ...
    "classifiedsCategories": MessageLookupByLibrary.simpleMessage("分类信息分类"),
    ...
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage("有问题吗？写信给我们！"),
    ...
    "invalidBooking": MessageLookupByLibrary.simpleMessage("无效的预订。"),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("必填项"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("在线客服"),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "此查询需要索引。请登录 Firebase 控制台，并点击下方按钮创建索引。您需要稍等片刻以启用。",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage("该订单中未找到产品"),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("挂起"),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage("未找到原地址"),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("安排促销"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "您的订单已收到，您可以通过 WhatsApp 发送同样的订单。",
    ),
    ...
    "shopAndSearchResults": MessageLookupByLibrary.simpleMessage("店铺和搜索结果"),
    "shopEmail": MessageLookupByLibrary.simpleMessage("商店邮箱"),
    "shopName": MessageLookupByLibrary.simpleMessage("商店名称"),
    "shopOnly": MessageLookupByLibrary.simpleMessage("仅店铺"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage("这是密封投标拍卖。"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage("等待房东确认"),
