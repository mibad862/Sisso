...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media a fost adăugată în playlist. ${length} element(e) nou(e) adăugat(e).";

  static String m3(attribute) => "Orice ${attribute}";

  static String m4(point) => "Punctele tale disponibile: ${point}";

  static String m5(name) =>
      "O ofertă a fost plasată cu succes pentru „${name}”";

  static String m6(id) => "Rezervare #${id}";

  static String m7(date) => "Rezervare solicitată la: ${date}";

  static String m8(amount) => "Cumpără acum pentru ${amount}";

  static String m9(author) => "Autor: ${author}";

  static String m10(fieldName) =>
      "Lungimea ${fieldName} nu poate fi mai mică de 3.";

  static String m11(currency) => "Moneda a fost schimbată în ${currency}";

  static String m12(number) => "${number} caractere rămase";
  ...
  static String m16(count) => "${count} animal";

  static String m17(count) => "${count} animale";

  static String m18(count) => "${count} copil";

  static String m19(count) => "${count} copii";

  static String m20(count) => "${count} oaspete";

  static String m21(count) => "${count} oaspeți";

  static String m22(count) => "${count} sugar";

  static String m23(count) => "${count} sugari";

  static String m24(count) => "${count} articol";

  static String m25(count) => "${count} articole";

  static String m26(count) => "${count} produs";

  static String m27(count) => "${count} produse";

  static String m28(count) => "${count} bilet";

  static String m29(count) => "${count} bilete";

  static String m30(country) => "Țara ${country} nu este acceptată";

  static String m31(currency) => "${currency} nu este acceptată";

  static String m32(currency) =>
      "Moneda ${currency} nu este acceptată de contul tău Razorpay. Te rugăm să contactezi suportul pentru a activa plățile internaționale sau să schimbi la o monedă acceptată.";

  static String m33(total) => "~${total} km";

  static String m34(timeLeft) => "Se termină în ${timeLeft}";

  static String m35(captcha) => "Introdu ${captcha} pentru a confirma:";

  static String m36(message) => "Eroare: ${message}";

  static String m37(message) => "Eroare: ${message}";

  static String m38(error) => "A apărut o eroare: ${error}";

  static String m39(date) => "Data evenimentului: ${date}";

  static String m40(time) => "Expiră în ${time}";
  ...
  static String m46(count) => "Maxim ${count} copii permiși";

  static String m47(size) => "Dimensiune maximă fișier: ${size} MB";

  static String m48(count) => "Sunt permise maximum ${count} persoane";

  static String m49(maxQuantity) =>
      "Cantitatea maximă permisă în coș este ${maxQuantity}";
  ...
  static String m52(count) => "Sunt necesare minimum ${count} caractere";
  ...
  static String m54(day) => "Sejurul minim este de ${day} zile";

  static String m55(amount) =>
      "Acest cupon necesită o achiziție minimă de ${amount}.";

  static String m56(value) => "Tranzacție minimă: ${value}";

  static String m57(value) => "Min ${value}";

  static String m58(count) => "Este necesar un minim de ${count} persoană(e)";

  static String m59(store) => "Mai multe de la ${store}";

  static String m60(number) => "Trebuie cumpărat în grupuri de ${number}";

  static String m61(itemCount) => "${itemCount} articole";

  static String m62(amount) => "Plătește ${amount}";

  static String m63(date) => "Plata scadentă: ${date}";

  static String m64(name) => "${name} a fost adăugat în coș cu succes";

  static String m65(total) => "Cantitate: ${total}";

  static String m66(name) => "A primit bani de la ${name}";

  static String m67(count) =>
      "Vrei să elimini ${count} produs(e) din lista ta de dorințe?";

  static String m68(percent) => "Reducere ${percent}%";

  static String m69(keyword, count) => "${keyword} (${count} articol)";

  static String m70(keyword, count) => "${keyword} (${count} articole)";

  static String m71(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m72(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m73(price) => "Începând de la ${price}";

  static String m74(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m75(total) => "${total} produse";

  static String m76(name) => "Transferă bani către ${name}";

  static String m77(price) => "Până la ${price}";

  static String m78(amount) => "Folosiți ${amount} puncte";
  ...
  static String m80(time) => "Valabil până la: ${time}";

  static String m81(date) => "Valabil până la ${date}";

  static String m82(number) => "Versiunea ${number}";

  static String m83(balance) => "Sold portofel: ${balance}";

  static String m84(message) => "Atenție: ${message}";
  ...
  static String m86(week) => "Săptămâna ${week}";

  static String m87(name) => "Bun venit, ${name}";

  static String m88(count) => "Selectezi ${count} produs(e)";

  static String m89(type) => "Ai trecut de ${type}";

  static String m90(point) => "Ai ${point} puncte";

  static String m91(price) => "Ai economisit ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Schimbarea regulată a parolei te ajută să-ți protejezi contul",
    ),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Adăugați, editați adresele de livrare",
    ),
    "addressNotFound": MessageLookupByLibrary.simpleMessage("Adresă negăsită"),
    ...
    "animals": MessageLookupByLibrary.simpleMessage("Animale"),
    "anyAttr": m3,
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Aprobat - Plătit"),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Ești sigur că vrei să închei acest chat?",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Articolul licitației nu a ajuns la prețul de rezervă",
        ),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Data rezervării"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Rezervare ștearsă cu succes",
    ),
    "bookingDetails": MessageLookupByLibrary.simpleMessage("Detalii rezervare"),
    ...
    "calendarView": MessageLookupByLibrary.simpleMessage(
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Nu se poate schimba parola. Vă rugăm să încercați din nou.",
    ),
    ...
    "cannotGetPaymentURL": MessageLookupByLibrary.simpleMessage(
      "Nu se poate obține URL-ul de plată",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Nu se poate crea factură pentru Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Nu se poate crea comandă pentru Razorpay",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Această setare determină pe ce pagini ale magazinului vor fi afișate produsele.",
    ),
    ...
    "changePasswordSubtitle": MessageLookupByLibrary.simpleMessage(
      "Actualizați parola de securitate",
    ),
    ...
    "characterRemain": m12,
    "chargeBack": MessageLookupByLibrary.simpleMessage("Returnare de plată"),
    "chat": MessageLookupByLibrary.simpleMessage("Chat"),
    "chatEnded": MessageLookupByLibrary.simpleMessage(
      "Chatul a fost încheiat. Te rugăm să începi un nou chat.",
    ),
    "chatListScreen": MessageLookupByLibrary.simpleMessage(
      "Lista de conversații",
    ),
    "chatNow": MessageLookupByLibrary.simpleMessage("Chat acum"),
    ...
    "children": MessageLookupByLibrary.simpleMessage("Copii"),
    "childrenDesc": MessageLookupByLibrary.simpleMessage("Vârste 2–12"),
    ...
    "confirmDeleteBooking": MessageLookupByLibrary.simpleMessage(
      "Sigur doriți să ștergeți această rezervare?",
    ),
    ...
    "confirmPasswordDoesNotMatch": MessageLookupByLibrary.simpleMessage(
      "Confirmarea parolei nu se potrivește",
    ),
    ...
    "copyResetLinkFromEmail": MessageLookupByLibrary.simpleMessage(
      "Copiați linkul de resetare din email și lipiți-l mai jos",
    ),
    ...
    "countTicket": m28,
    "countTickets": m29,
    "countries": MessageLookupByLibrary.simpleMessage("țări"),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage(
      "Cuponul a fost eliminat cu succes",
    ),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Creează index"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Adresă implicită"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Adresa implicită a fost actualizată cu succes",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Implicit"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Șterge rezervarea"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Nu s-a putut șterge rezervarea.",
    ),
    ...
    "deliveryTime": MessageLookupByLibrary.simpleMessage("Timp de livrare"),
    "denied": MessageLookupByLibrary.simpleMessage("Respins"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Numele afișat este generat automat din prenume și nume",
    ),
    "distance": m33,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Editează adresa"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Încheie chatul"),
    ...
    "enterYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Introduceți informațiile despre adresă",
    ),
    "enterYourCurrentLocation": MessageLookupByLibrary.simpleMessage(
      "Introdu locația ta actuală",
    ),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Eroare"),
    ...
    "failed": MessageLookupByLibrary.simpleMessage("Eșuat"),
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Crearea recenziei a eșuat",
    ),
    ...
    "failedToLoadCheckoutFields": MessageLookupByLibrary.simpleMessage(
      "Eroare la încărcarea câmpurilor de finalizare",
    ),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Cost final"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Obține bilet"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Aveți un cupon?"),
    "haveYouGotQuestion": MessageLookupByLibrary.simpleMessage(
      "Ai o întrebare? Scrie-ne!",
    ),
    "hidden": MessageLookupByLibrary.simpleMessage("Ascuns"),
    ...
    "infants": MessageLookupByLibrary.simpleMessage("Sugari"),
    "infantsDesc": MessageLookupByLibrary.simpleMessage("Sub 2 ani"),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Ups! Nu am putut deschide acest link.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("este necesar"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Chat live"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Mesajul dvs. scurt către proprietarul anunțului (opțional)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Această interogare necesită un index. Vă rugăm să vă conectați la consola Firebase și să creați indexul apăsând butonul de mai jos. Trebuie să așteptați puțin până când este activat.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Index Firestore lipsă detectat!",
    ),
    ...
    "network": MessageLookupByLibrary.simpleMessage("Rețea"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Parolă nouă"),
    ...
    "noCheckoutFieldsAvailable": MessageLookupByLibrary.simpleMessage(
      "Nu există câmpuri de finalizare disponibile",
    ),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("Fără nume afișat"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Fără internet. Reconectați-vă pentru a continua cumpărăturile.",
    ),
    ...
    "noMembershipPlans": MessageLookupByLibrary.simpleMessage(
      "Nu sunt disponibile planuri de abonament",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Nu au fost găsite produse în această comandă",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Nu există informații despre magazin",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Nu ești autentificat, chatul va expira dacă ieși.",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("În așteptare"),
    ...
    "orderExtra": MessageLookupByLibrary.simpleMessage("Comandă extra"),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Adresa originală nu a fost găsită",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Altă adresă"),
    ...
    "pasteResetLink": MessageLookupByLibrary.simpleMessage(
      "Lipiți linkul de resetare din email",
    ),
    ...
    "paymentCancelled": MessageLookupByLibrary.simpleMessage("Plata anulată"),
    ...
    "personalInformationSubtitle": MessageLookupByLibrary.simpleMessage(
      "Actualizați numele, numărul de telefon",
    ),
    ...
    "pleaseAddAddressFirst": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să adăugați mai întâi o adresă",
    ),
    ...
    "pleaseAdjustYourCart": MessageLookupByLibrary.simpleMessage(
      "Te rugăm să ajustezi coșul înainte de a finaliza comanda.",
    ),
    ...
    "pleaseAllowAccessLocation": MessageLookupByLibrary.simpleMessage(
      "Te rugăm să permiți accesul la locație",
    ),
    "pleaseCheckFollowingIssues": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să verificați următoarele probleme:",
    ),
    ...
    "pleaseConfirmNewPassword": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să confirmați noua parolă",
    ),
    ...
    "pleaseEnterNewPassword": MessageLookupByLibrary.simpleMessage(
      "Te rugăm să introduci parola nouă",
    ),
    ...
    "pleaseSelectDeliveryTime": MessageLookupByLibrary.simpleMessage(
      "Vă rugăm să selectați timpul de livrare",
    ),
    ...
    "pressBackButtonAgainToExit": MessageLookupByLibrary.simpleMessage(
      "Apasă din nou pentru a ieși",
    ),
    "pressOnDayToSeeFullPrice": MessageLookupByLibrary.simpleMessage(
      "Apăsați și mențineți o zi pentru a vedea prețul complet",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Procesat"),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produsul nu este pregătit pentru re-comandă",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Variațiile produsului nu sunt disponibile",
    ),
    ...
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Ofertă"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Rambursat"),
    "refunds": MessageLookupByLibrary.simpleMessage("Rambursări"),
    "regions": MessageLookupByLibrary.simpleMessage("Regiuni"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Relevanță"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Date de închiriere"),
    "rentalsCategories": MessageLookupByLibrary.simpleMessage(
      "Categorii de închirieri",
    ),
    ...
    "resetLink": MessageLookupByLibrary.simpleMessage("Link de resetare"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Anulat"),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Adrese salvate"),
    "savedToGallery": MessageLookupByLibrary.simpleMessage("Salvat în galerie"),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Programare vânzare"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Căutați țări..."),
    ...
    "selectProductBrands": MessageLookupByLibrary.simpleMessage(
      "Selectați brandurile produselor",
    ),
    "selectProductTags": MessageLookupByLibrary.simpleMessage(
      "Selectați etichetele produsului",
    ),
    ...
    "sendOrderViaWhatsApp": MessageLookupByLibrary.simpleMessage(
      "Trimite comanda prin WhatsApp",
    ),
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Comanda ta a fost primită în sistem și poți trimite aceeași comandă prin WhatsApp.",
    ),
    ...
    "shopifyAccountManagement": MessageLookupByLibrary.simpleMessage(
      "Administrare cont Shopify",
    ),
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Membru Shopify"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Să conțină cifre și caractere speciale",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• Să conțină litere mari și mici",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Începe chatul"),
    ...
    "thisIsSealedBidAuction": MessageLookupByLibrary.simpleMessage(
      "Aceasta este o licitație cu ofertă sigilată.",
    ),
    ...
    "tips": MessageLookupByLibrary.simpleMessage("Sfaturi:"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Branduri de top"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Cost total"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Tipuri"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Nedefinit"),
    ...
    "updateYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Actualizați informațiile despre adresă",
    ),
    ...
    "userNameOrPasswordIncorrect": MessageLookupByLibrary.simpleMessage(
      "Numele de utilizator/emailul sau parola sunt incorecte.",
    ),
    ...
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Folosiți coduri de stat din 2 litere (CA, NY, TX)\n• Folosiți coduri de țară din 2 litere (US, CA, GB)\n• Verificați formatul codului poștal/ZIP\n• Asigurați-vă că toate câmpurile obligatorii sunt completate",
    ),
    ...
    "verifiedListing": MessageLookupByLibrary.simpleMessage("Anunț verificat"),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Anulat"),
    ...
    "waitingOwnerConfirmation": MessageLookupByLibrary.simpleMessage(
      "Se așteaptă confirmarea proprietarului",
    ),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Trebuie să vă autentificați pentru a vedea adresele",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Evaluarea ta"),
