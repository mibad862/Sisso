...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(length) =>
      "Media har lagts till i spellistan. ${length} nytt objekt har lagts till.";

  static String m3(attribute) => "Alla ${attribute}";

  static String m4(point) => "Dina tillgängliga poäng: ${point}";

  static String m5(name) => "Lyckades lägga ett bud på \'${name}\'";

  static String m6(id) => "Bokning #${id}";

  static String m7(date) => "Bokning begärd den: ${date}";

  static String m8(amount) => "Köp nu för ${amount}";

  static String m9(author) => "Av: ${author}";

  static String m10(fieldName) =>
      "${fieldName} får inte vara kortare än 3 tecken.";

  static String m11(currency) => "Ändrade valuta till ${currency}";

  static String m12(number) => "${number} tecken kvar";

  static String m13(date) => "Incheckning: ${date}";

  static String m14(date) => "Utcheckning: ${date}";

  static String m15(priceRate, pointRate) =>
      "${priceRate} = ${pointRate} poäng";

  static String m16(count) => "${count} djur";

  static String m17(count) => "${count} djur";

  static String m18(count) => "${count} barn";

  static String m19(count) => "${count} barn";

  static String m20(count) => "${count} gäst";

  static String m21(count) => "${count} gäster";

  static String m22(count) => "${count} spädbarn";

  static String m23(count) => "${count} spädbarn";

  static String m24(count) => "${count} artikel";

  static String m25(count) => "${count} artiklar";

  static String m26(count) => "${count} artikel";

  static String m27(count) => "${count} artiklar";

  static String m28(count) => "${count} biljett";

  static String m29(count) => "${count} biljetter";

  static String m30(country) => "${country} stöds inte";

  static String m31(currency) => "${currency} stöds inte";

  static String m32(currency) =>
      "Valutan ${currency} stöds inte av ditt Razorpay-konto. Kontakta supporten för att aktivera internationella betalningar eller byt till en stödd valuta.";

  static String m33(total) => "~${total} km";

  static String m34(timeLeft) => "Slutar om ${timeLeft}";

  static String m35(captcha) => "Ange ${captcha} för att bekräfta:";

  static String m36(message) => "Fel: ${message}";

  static String m37(message) => "Fel: ${message}";

  static String m38(error) => "Ett fel inträffade: ${error}";

  static String m39(date) => "Eventdatum: ${date}";

  static String m40(time) => "Går ut om ${time}";
  ...
  static String m46(count) => "Maximalt ${count} barn tillåtna";

  static String m47(size) => "Maximal filstorlek: ${size} MB";

  static String m48(count) => "Högst ${count} gäster tillåtna";

  static String m49(maxQuantity) =>
      "Maximalt tillåtet antal i varukorgen är ${maxQuantity}";
  ...
  static String m52(count) => "Minst ${count} tecken krävs";
  ...
  static String m54(day) => "Minsta vistelse är ${day} dagar";

  static String m55(amount) =>
      "Denna kupong kräver ett köp på minst ${amount}.";

  static String m56(value) => "Minsta transaktion: ${value}";

  static String m57(value) => "Min ${value}";

  static String m58(count) => "Minst ${count} gäst(er) krävs";

  static String m59(store) => "Mer från ${store}";

  static String m60(number) => "Måste köpas i grupper om ${number}";

  static String m61(itemCount) => "${itemCount} artiklar";

  static String m62(amount) => "Betala ${amount}";

  static String m63(date) => "Betalning förfaller: ${date}";

  static String m64(name) => "${name} har lagts till i kundvagnen";

  static String m65(total) => "Antal: ${total}";

  static String m66(name) => "Tog emot pengar från ${name}";

  static String m67(count) =>
      "Vill du ta bort ${count} artikel/artiklar från din önskelista?";

  static String m68(percent) => "Rea ${percent}%";

  static String m69(keyword, count) => "${keyword} (${count} objekt)";

  static String m70(keyword, count) => "${keyword} (${count} objekt)";

  static String m71(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m72(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m73(price) => "Startar från ${price}";

  static String m74(fieldName) => "Fältet ${fieldName} är obligatoriskt";

  static String m75(total) => "${total} produkter";

  static String m76(name) => "Överför pengar till ${name}";

  static String m77(price) => "Upp till ${price}";

  static String m78(amount) => "Använd ${amount} poäng";
  ...
  static String m80(time) => "Giltig till: ${time}";

  static String m81(date) => "Giltig till ${date}";

  static String m82(number) => "Version ${number}";

  static String m83(balance) => "Plånbokssaldo: ${balance}";

  static String m84(message) => "Varning: ${message}";
  ...
  static String m86(week) => "Vecka ${week}";

  static String m87(name) => "Välkommen ${name}";

  static String m88(count) => "Du väljer ${count} artikel/artiklar";

  static String m89(type) => "Du har klarat ${type}";

  static String m90(point) => "Du har ${point} poäng";

  static String m91(price) => "Du sparade ${price}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "accountSecurity": MessageLookupByLibrary.simpleMessage("Kontosäkerhet"),
    "accountSecurityDescription": MessageLookupByLibrary.simpleMessage(
      "Att byta lösenord regelbundet hjälper till att skydda ditt konto",
    ),
    ...
    "addedToCart": MessageLookupByLibrary.simpleMessage("Tillagd i kundvagn"),
    ...
    "addressManagementSubtitle": MessageLookupByLibrary.simpleMessage(
      "Lägg till, redigera leveransadresser",
    ),
    "addressNotFound": MessageLookupByLibrary.simpleMessage(
      "Adress hittades inte",
    ),
    ...
    "animals": MessageLookupByLibrary.simpleMessage("Djur"),
    "anyAttr": m3,
    ...
    "approvedPaid": MessageLookupByLibrary.simpleMessage("Godkänd - Betald"),
    "approvedRequests": MessageLookupByLibrary.simpleMessage(
      "Godkända förfrågningar",
    ),
    "approvedUnpaid": MessageLookupByLibrary.simpleMessage("Godkänd - Obetald"),
    ...
    "areYouSureEndChat": MessageLookupByLibrary.simpleMessage(
      "Är du säker på att du vill avsluta chatten?",
    ),
    ...
    "auctionItemDidNotMakeItToReservePrice":
        MessageLookupByLibrary.simpleMessage(
          "Auktionsobjektet nådde inte reservationspriset",
        ),
    ...
    "available": MessageLookupByLibrary.simpleMessage("Tillgänglig"),
    ...
    "bookingDate": MessageLookupByLibrary.simpleMessage("Bokningsdatum"),
    "bookingDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Bokningen har tagits bort",
    ),
    "bookingDetails": MessageLookupByLibrary.simpleMessage("Bokningsdetaljer"),
    "bookingHistory": MessageLookupByLibrary.simpleMessage("Bokningshistorik"),
    "bookingID": m6,
    "bookingLocation": MessageLookupByLibrary.simpleMessage("Bokningsplats"),
    ...
    "calendarView": MessageLookupByLibrary.simpleMessage("Kalendervy"),
    ...
    "cancelBooking": MessageLookupByLibrary.simpleMessage("Avboka bokning"),
    "cancelBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Det gick inte att avboka bokningen.",
    ),
    ...
    "cannotChangePassword": MessageLookupByLibrary.simpleMessage(
      "Kan inte ändra lösenord. Försök igen.",
    ),
    ...
    "cantCreateRazorpayInvoice": MessageLookupByLibrary.simpleMessage(
      "Kan inte skapa faktura för Razorpay",
    ),
    "cantCreateRazorpayOrder": MessageLookupByLibrary.simpleMessage(
      "Kan inte skapa order för Razorpay",
    ),
    ...
    "catalogVisibilityTooltip": MessageLookupByLibrary.simpleMessage(
      "Den här inställningen avgör på vilka butikssidor produkterna visas.",
    ),
    ...
    "children": MessageLookupByLibrary.simpleMessage("Barn"),
    "childrenDesc": MessageLookupByLibrary.simpleMessage("Åldrar 2–12"),
    ...
    "company": MessageLookupByLibrary.simpleMessage("Företag"),
    "completed": MessageLookupByLibrary.simpleMessage("Slutförd"),
    ...
    "confirmPasswordDoesNotMatch": MessageLookupByLibrary.simpleMessage(
      "Bekräftelse av lösenord matchar inte",
    ),
    ...
    "copyResetLinkFromEmail": MessageLookupByLibrary.simpleMessage(
      "Kopiera återställningslänken från ditt e-postmeddelande och klistra in den nedan",
    ),
    ...
    "couponRemove": MessageLookupByLibrary.simpleMessage("Rabattkod borttagen"),
    ...
    "createIndex": MessageLookupByLibrary.simpleMessage("Skapa index"),
    ...
    "defaultAddress": MessageLookupByLibrary.simpleMessage("Standardadress"),
    "defaultAddressUpdatedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Standardadressen har uppdaterats",
    ),
    "defaultLabel": MessageLookupByLibrary.simpleMessage("Standard"),
    ...
    "deleteBooking": MessageLookupByLibrary.simpleMessage("Radera bokning"),
    "deleteBookingFailed": MessageLookupByLibrary.simpleMessage(
      "Det gick inte att ta bort bokningen.",
    ),
    ...
    "deliveryTime": MessageLookupByLibrary.simpleMessage("Leveranstid"),
    "denied": MessageLookupByLibrary.simpleMessage("Nekad"),
    ...
    "displayNameDescription": MessageLookupByLibrary.simpleMessage(
      "Visningsnamn genereras automatiskt från för- och efternamn",
    ),
    "distance": m33,
    ...
    "editAddress": MessageLookupByLibrary.simpleMessage("Redigera adress"),
    ...
    "endChat": MessageLookupByLibrary.simpleMessage("Avsluta chatt"),
    ...
    "errorPrefix": MessageLookupByLibrary.simpleMessage("Fel"),
    ...
    "failedToCreateReview": MessageLookupByLibrary.simpleMessage(
      "Det gick inte att skapa recension",
    ),
    ...
    "finalCost": MessageLookupByLibrary.simpleMessage("Slutlig kostnad"),
    ...
    "getTicket": MessageLookupByLibrary.simpleMessage("Hämta biljett"),
    ...
    "haveACoupon": MessageLookupByLibrary.simpleMessage("Har du en kupong?"),
    ...
    "infants": MessageLookupByLibrary.simpleMessage("Spädbarn"),
    "infantsDesc": MessageLookupByLibrary.simpleMessage("Under 2"),
    ...
    "instantBooking": MessageLookupByLibrary.simpleMessage("Omedelbar bokning"),
    ...
    "invalidBooking": MessageLookupByLibrary.simpleMessage("Ogiltig bokning."),
    ...
    "invalidUrl": MessageLookupByLibrary.simpleMessage(
      "Hoppsan! Vi kunde inte öppna den här länken.",
    ),
    ...
    "isRequired": MessageLookupByLibrary.simpleMessage("krävs"),
    ...
    "liveChat": MessageLookupByLibrary.simpleMessage("Livechatt"),
    ...
    "messageToListingOwner": MessageLookupByLibrary.simpleMessage(
      "Ditt korta meddelande till annonsägaren (valfritt)",
    ),
    ...
    "missingFirestoreIndexDescription": MessageLookupByLibrary.simpleMessage(
      "Den här frågan kräver ett index. Logga in på Firebase-konsolen och skapa indexet genom att klicka på knappen nedan. Du måste vänta en stund tills det aktiveras.",
    ),
    "missingFirestoreIndexTitle": MessageLookupByLibrary.simpleMessage(
      "Saknat Firestore-index upptäckt!",
    ),
    ...
    "nameIsRequired": MessageLookupByLibrary.simpleMessage("Namn krävs"),
    ...
    "newPasswordSection": MessageLookupByLibrary.simpleMessage("Nytt lösenord"),
    ...
    "noCheckoutFieldsAvailable": MessageLookupByLibrary.simpleMessage(
      "Inga utcheckningsfält tillgängliga",
    ),
    ...
    "noDisplayName": MessageLookupByLibrary.simpleMessage("Inget visningsnamn"),
    ...
    "noInternetReconnectToContinue": MessageLookupByLibrary.simpleMessage(
      "⚠️ Ingen internetanslutning. Återanslut för att fortsätta handla.",
    ),
    ...
    "noProductsFoundInOrder": MessageLookupByLibrary.simpleMessage(
      "Inga produkter hittades i denna order",
    ),
    ...
    "noStoreInformation": MessageLookupByLibrary.simpleMessage(
      "Ingen butiksinformation tillgänglig",
    ),
    ...
    "notLoggedInLiveChatWarning": MessageLookupByLibrary.simpleMessage(
      "Du är inte inloggad, chatten kommer att upphöra om du avslutar.",
    ),
    ...
    "onHold": MessageLookupByLibrary.simpleMessage("På vänt"),
    ...
    "orderExtra": MessageLookupByLibrary.simpleMessage("Beställ extra"),
    ...
    "originalAddressNotFound": MessageLookupByLibrary.simpleMessage(
      "Ursprunglig adress hittades inte",
    ),
    "otherAddress": MessageLookupByLibrary.simpleMessage("Annan adress"),
    ...
    "passwordTips": MessageLookupByLibrary.simpleMessage("Lösenordstips:"),
    "passwordsDoNotMatch": MessageLookupByLibrary.simpleMessage(
      "Lösenorden matchar inte",
    ),
    "pasteResetLink": MessageLookupByLibrary.simpleMessage(
      "Klistra in återställningslänk från e-post",
    ),
    ...
    "pressOnDayToSeeFullPrice": MessageLookupByLibrary.simpleMessage(
      "Håll ned en dag för att se fullständigt pris",
    ),
    ...
    "processed": MessageLookupByLibrary.simpleMessage("Behandlad"),
    ...
    "productNotReadyForReorder": MessageLookupByLibrary.simpleMessage(
      "Produkten är inte redo för ombeställning",
    ),
    ...
    "productVariationsNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Produktvarianter är inte tillgängliga",
    ),
    ...
    "quantityMustBeGreaterThanZero": MessageLookupByLibrary.simpleMessage(
      "Antalet måste vara större än noll",
    ),
    "quantityProductExceedInStock": MessageLookupByLibrary.simpleMessage(
      "Den aktuella kvantiteten är större än lagermängden",
    ),
    "quoteLabel": MessageLookupByLibrary.simpleMessage("Offert"),
    ...
    "refunded": MessageLookupByLibrary.simpleMessage("Återbetald"),
    "refunds": MessageLookupByLibrary.simpleMessage("Återbetalningar"),
    "regions": MessageLookupByLibrary.simpleMessage("Regioner"),
    ...
    "relevance": MessageLookupByLibrary.simpleMessage("Relevans"),
    ...
    "rentalDates": MessageLookupByLibrary.simpleMessage("Hyresdatum"),
    "rentalsCategories": MessageLookupByLibrary.simpleMessage(
      "Uthyrningskategorier",
    ),
    ...
    "reservePriceHasBeenMet": MessageLookupByLibrary.simpleMessage(
      "Reservationspriset har uppnåtts",
    ),
    "reservePriceHasNotBeenMet": MessageLookupByLibrary.simpleMessage(
      "Reservationspriset har inte uppnåtts",
    ),
    "reset": MessageLookupByLibrary.simpleMessage("Återställ"),
    "resetLink": MessageLookupByLibrary.simpleMessage("Återställningslänk"),
    ...
    "reversed": MessageLookupByLibrary.simpleMessage("Återförd"),
    ...
    "sale": m68,
    "saleFromDate": MessageLookupByLibrary.simpleMessage("Rea från datum"),
    "salePrice": MessageLookupByLibrary.simpleMessage("Reapris"),
    "saleToDate": MessageLookupByLibrary.simpleMessage("Rea till datum"),
    "saleToDateCannotBeEarlier": MessageLookupByLibrary.simpleMessage(
      "Slutdatum för rean kan inte vara tidigare än startdatumet för rean.",
    ),
    ...
    "savedAddresses": MessageLookupByLibrary.simpleMessage("Sparade adresser"),
    ...
    "scheduleSale": MessageLookupByLibrary.simpleMessage("Schemalägg rea"),
    ...
    "searchCountries": MessageLookupByLibrary.simpleMessage("Sök länder..."),
    ...
    "selectTimeSlot": MessageLookupByLibrary.simpleMessage("Välj en tidsslot"),
    ...
    "sendOrderViaWhatsAppMsg": MessageLookupByLibrary.simpleMessage(
      "Din beställning har tagits emot i systemet och du kan skicka samma beställning via WhatsApp.",
    ),
    ...
    "setAsDefault": MessageLookupByLibrary.simpleMessage("Ange som standard"),
    ...
    "shopifyAccountManagement": MessageLookupByLibrary.simpleMessage(
      "Shopify kontohantering",
    ),
    "shopifyMember": MessageLookupByLibrary.simpleMessage("Shopify-medlem"),
    ...
    "shouldContainNumbersSpecialChars": MessageLookupByLibrary.simpleMessage(
      "• Ska innehålla siffror och specialtecken",
    ),
    "shouldContainUpperLowercase": MessageLookupByLibrary.simpleMessage(
      "• Ska innehålla både stora och små bokstäver",
    ),
    ...
    "startChat": MessageLookupByLibrary.simpleMessage("Starta chatt"),
    ...
    "topBrands": MessageLookupByLibrary.simpleMessage("Toppmärken"),
    ...
    "totalCost": MessageLookupByLibrary.simpleMessage("Totalkostnad"),
    ...
    "types": MessageLookupByLibrary.simpleMessage("Typer"),
    ...
    "undefined": MessageLookupByLibrary.simpleMessage("Odefinierad"),
    ...
    "updateAddress": MessageLookupByLibrary.simpleMessage("Uppdatera adress"),
    ...
    "updateYourAddressInformation": MessageLookupByLibrary.simpleMessage(
      "Uppdatera din adressinformation",
    ),
    ...
    "userNameOrPasswordIncorrect": MessageLookupByLibrary.simpleMessage(
      "Användarnamn/e-post eller lösenord är felaktigt.",
    ),
    ...
    "validUntil": m80,
    "validUntilDate": m81,
    "validationError": MessageLookupByLibrary.simpleMessage("Valideringsfel"),
    "validationTips": MessageLookupByLibrary.simpleMessage(
      "• Använd tvåbokstavskoder för delstat (CA, NY, TX)\n• Använd tvåbokstavskoder för land (US, CA, GB)\n• Kontrollera formatet på postnummer\n• Se till att alla obligatoriska fält är ifyllda",
    ),
    ...
    "voided": MessageLookupByLibrary.simpleMessage("Ogiltigförklarad"),
    ...
    "youNeedToLoginToSeeAddresses": MessageLookupByLibrary.simpleMessage(
      "Du måste logga in för att se adresser",
    ),
    ...
    "yourRating": MessageLookupByLibrary.simpleMessage("Ditt betyg"),
