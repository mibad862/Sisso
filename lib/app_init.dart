...
import 'widgets/splashscreen/splash_screen_index.dart';
...
class _AppInitState extends BaseScreen<AppInit> {
  ...
  Future<void> loadInitData() async {
    try {
      ...
      final filterFeatureModel = getModel<FilterFeatureModel>();
      ...
      /// Load layout config
      appConfig = await appModel.loadAppConfig();
      ...
      Future.delayed(Duration.zero, () async {
        ...
        final priorityRequests = <Future>[
          ...
          if (listingLocationModel != null) listingLocationModel.getLocations(),
        ];
