...
Map get kCashfreeConfig => Configurations.cashfreeConfig;

Map get kTapConfig => Configurations.tapConfig;

Map get kModemPayConfig => Configurations.modemPayConfig;
...
Map get kPhonePeConfig => Configurations.phonepeConfig;

Map get kBankTransferConfig => Configurations.bankTransferConfig;

Map get kCashOnDeliveryConfig => Configurations.cashOnDeliveryConfig;

Map get kWhatsAppOrderConfig => Configurations.whatsAppOrderConfig;

Map get kAfterShip => Configurations.afterShip;
