...
_ShopifyPaymentConfig _$ShopifyPaymentConfigFromJson(
  ...
  applePayConfig: json['applePayConfig'] == null
      ...
      : ApplePayConfig.fromJson(json['applePayConfig'] as Map<String, dynamic>),
);

Map<String, dynamic> _$ShopifyPaymentConfigToJson(
  _ShopifyPaymentConfig instance,
) => <String, dynamic>{
