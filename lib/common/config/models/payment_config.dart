...
class PaymentConfig {
  ...
  bool enableHybridPayment = false;
  ...
  bool get guestCheckout => kAuthConfig.enable ? _guestCheckout : true;
  ...
  PaymentConfig.fromJson(dynamic json) {
    ...
    // 'EnableReview' is deprecated and kept for backward compatibility
    enablePreview = json['EnablePreview'] ?? json['EnableReview'] ?? false;
    ...
    showNativeCheckoutSuccessScreenForWebview =
        ...
        true;
    enableHybridPayment = json['EnableHybridPayment'] ?? false;
  ...
  Map toJson() {
    ...
    map['EnablePreview'] = enablePreview;
    ...
    map['ShowNativeCheckoutSuccessScreenForWebview'] =
        showNativeCheckoutSuccessScreenForWebview;
    map['EnableHybridPayment'] = enableHybridPayment;
