...
class DefaultConfig {
  ...
  static Map advanceConfig = {
    ...
    'DownloadPageUrl': 'https://inspireui.com/product/',

    'AboutUSPageUrl': 'https://inspireui.com/about/',

    'NewsPageUrl': 'https://inspireui.com/blog/',
    ...
    'EnableWooCheckoutFieldManager': false,
  ...
  static Map wishListConfig = {'type': 'normal', 'showCartButton': true};
  ...
  static Map adConfig = {
    ...
    'ads': [
      ...
      },
      {
        ...
        'showOnScreens': ['home', 'search', 'product'],
        'hideOnScreens': [],
      },
      {
        'type': 'interstitial',
  ...
  static Map cashfreeConfig = {
    'paymentMethodIds': ['cashfree'],
    'enabled': false,
  };
  static Map tapConfig = {};
  static Map modemPayConfig = {
  ...
  static Map whatsAppOrderConfig = {
  ...
  static Map orderDelivery = {'enable': false};
  ...
  static DynamicLinkConfig dynamicLinkConfig = DynamicLinkConfig.fromJson({
    ...
    'serviceConfigs': {
      ...
      'selfhosted': {
        'supportedDomains': ['inspireui.com'],
  ...
  static OfflineModeConfig offlineModeConfig = const OfflineModeConfig(
    enable: false,
  );
}
