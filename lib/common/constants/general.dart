...
final bool isWindows = UniversalPlatform.isWindows;
...
enum BookStatus {
  ...
  bool get isBookingFailed =>
      [BookStatus.error, BookStatus.unavailable].contains(this);
}
...
final kCardDesign = kIsWeb ? CardDesign.simpleForWeb : CardDesign.card;
