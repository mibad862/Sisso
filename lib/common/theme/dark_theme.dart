...
ThemeData buildDarkTheme(
  ...
  final dialogTheme = base.dialogTheme;
  ...
  return base.copyWith(
    ...
    textTheme: buildTextTheme(
      ...
      fontFamily,
      fontHeader,
    ).apply(displayColor: kLightBG, bodyColor: kLightBG),
    ...
    appBarTheme: AppBarTheme(
      ...
      systemOverlayStyle: kSystemOverlayStyleDark,
    ),
    ...
    dialogTheme: dialogTheme.copyWith(backgroundColor: kDarkBG),
    colorScheme: kDarkColorScheme
        .copyWith(secondary: kDarkAccent)
