class NotionDataTools {
  ...
  static String? fromTitle(Map<String, dynamic>? title) {
    try {
      ...
      return title['title'][0]['text']['content'].toString();
    } catch (e) {
      return null;
    }
  }
  ...
  static Map<String, dynamic> toFilterRichText(
    String property,
    String text, {
  ...
  static Map<String, dynamic> toFilterTitle(
    String property,
    String text, {
    String condition = 'equals',
  }) {
  ...
  ///
  /// `ends_with`(string): Only return pages where the page property value ends with the provided value.
  static Map<String, dynamic> toFilterNumber(
    String property,
    num number, {
    String condition = 'equals',
  }) {
