...
class _StoreDetailState extends State<StoreDetailScreen>
  ...
  List<Widget> _buildPages() {
    return List.generate(_titles.length, (index) {
      switch (_titles[index]) {
        ...
        case 'info':
          return StoreInfoWidget(store: widget.store);
        default:
          return const SizedBox();
      }
    });
  ...
  String get profileUrl => widget.store.profileUrl;
                  ...
                  leading: IconButton(
                    icon: CircleAvatar(
                      backgroundColor: Theme.of(
                        context,
                      ).colorScheme.surface.withValueOpacity(0.2),
                      ...
                      return FlexibleSpaceBar(
                        ...
                        background: Stack(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              color: Colors.black12.withValueOpacity(0.5),
