...
import '../screens/checkout/address_management_screen.dart';
import '../screens/checkout/address_selection_screen.dart';
...
class Routes {
  ...
  static Route getRouteGenerate(RouteSettings settings) {
    ...
    switch (routingData.route) {
      ...
      case RouteList.backdrop:
        ...
        if (arguments is BackDropArguments) {
          ...
          return _buildRoute(routeSetting, (context) {
            ...
            final categoryMenuShowDepth = arguments.categoryMenuShowDepth;
            ...
            try {
              ...
              if (productModel.brandIds != brandIds && firstBuild) {
                productModel.setProductsList([], notify: false);
                productModel.brandIds = null;
              }
              ...
              if (categoryId != null ||
                ...
                productModel.fetchProductsByCategory(
                  categoryId: firstBuild
                      ? categoryId
                      : productModel.categoryIds,
                  brandIds: firstBuild ? brandIds : productModel.brandIds,
                  categoryName: firstBuild
                      ? categoryName
              ...
              if (animationConfig != null && animationConfig is Map) {
                animatedConfig = AnimatedItemListConfig.tryParse(
                  animationConfig,
                );
              }
              ...
              var productConfig = configValue
                ...
                ..tag = tagId
                ..name = configValue.onSale && showCountdown
                    ? categoryName
                    : null
                ..showCountDown =
                    configValue.showCountDown &&
                    configValue.onSale &&
                    showCountdown;

              final productsListFilter = config is Map
                  ? ProductsListFilter.fromJson(
            ...
            return MultiProvider(
              providers: [
                if (Layout.isDisplayDesktop(context) || kIsWeb)
                  ChangeNotifierProvider(create: (context) => SearchWebModel()),
      ...
      case RouteList.category:
        ...
        return _buildRoute(
          settings,
          (_) => const CategoriesScreen(key: Key('category'), showSearch: true),
        );
      case RouteList.categorySearch:
        return _buildRouteFade(settings, (ct) => const CategorySearch());
      ...
      case RouteList.login:
        final data = settings.arguments;
        var showGuestButton = false;
        if (data is Map) {
          showGuestButton =
              bool.tryParse('${data['showGuestButton']}') ?? false;
        }
        return _buildRoute(
          settings,
          (_) => LoginScreen(showGuestButton: showGuestButton),
        );
      ...
      case RouteList.listBlog:
        return _buildRoute(settings, (_) => ListBlogScreen());
      case RouteList.page:
        final data = settings.arguments;
        if (data is TabBarMenuConfig) {
          return _buildRoute(
      ...
      case RouteList.html:
        ...
        if (data is TabBarMenuConfig) {
          return _buildRoute(
            settings,
            (_) => HtmlWebViewScreen(data: data.jsonData['data']),
          );
        }
        return _errorRoute();
      ...
      case RouteList.pageTab:
        final data = settings.arguments;
        if (data is TabBarMenuConfig) {
          return _buildRoute(settings, (context) => PageTabScreen(data));
        }
        return _errorRoute(data.toString());
      case RouteList.home:
        final argument = settings.arguments;
        final controller = argument is TabBarMenuConfig
            ? argument.scrollController
            : null;

        return _buildRoute(
          settings,
          (context) => HomeScreen(scrollController: controller),
        );
      ...
      case RouteList.products:
        ...
        return _buildRoute(
          settings,
          (context) => ChangeNotifierProvider<FilterBrandModel>(
            create: (context) => FilterBrandModel(),
            child: ProductsScreen(
              searchText: argument?['searchText'],
              categoryMenuStyle: argument?['categoryMenuStyle'],
              categoryMenuShowDepth:
                  bool.tryParse('${argument?['categoryMenuShowDepth']}') ??
                  false,
              allowFilterMultipleCategory: bool.tryParse(
                '${argument?['allowFilterMultipleCategory']}',
              ),
            ),
          ),
        );
      case RouteList.onBoarding:
        return _buildRoute(settings, (context) => const OnBoardingScreen());
      case RouteList.cart:
        ...
        return _buildRoute(settings, (context) => const CartScreen());
              ...
              child: ChangeNotifierProvider.value(
                ...
                child: SubcategoryScreen(
                  ...
                  allowFilterMultipleCategory:
                      arguments.allowFilterMultipleCategory,
                  categoryMenuStyle: arguments.categoryMenuStyle,
                  categoryMenuShowDepth: arguments.categoryMenuShowDepth,
                ),
              ),
            ),
          );
      ...
      case RouteList.account:
        return _buildRoute(
          settings,
          (context) => Services().widget.renderAccountScreen(),
        );
      case RouteList.personalInfo:
        return _buildRoute(
          settings,
          (context) => Services().widget.renderPersonalInfoScreen(),
        );
      case RouteList.changePassword:
        return _buildRoute(
          settings,
          (context) => Services().widget.renderChangePasswordScreen(),
        );
      case RouteList.orderdSuccess:
        ...
        return _buildRoute(settings, (context) {
          if (Layout.isDisplayDesktop(context)) {
            return WebOrderedSuccess(order: arguments?['order']);
          }

          return OrderedSuccess(order: arguments?['order']);
        });
        ...
        if (data is TabBarMenuConfig) {
          styleVersions = data.jsonData['styleVersions'] is List
              ? (data.jsonData['styleVersions'] as List)
                    ...
                    .toList()
              : styleVersions;
          videoOrder = data.jsonData['order']?.toString();
          videoOrderby = data.jsonData['orderby']?.toString();
        }
        return _buildRoute(
          settings,
      ...
      case RouteList.selectAddress:
        ...
        return _buildRoute(
          settings,
          (context) => ChooseAddressScreen(arguments),
        );
      case RouteList.addressBook:
        final args = settings.arguments;
        final currentAddress = args is Address? ? args : null;

        return _buildRoute(
          settings,
          (context) => ChangeNotifierProvider(
            create: (context) => AddressManagementModel(),
            child: AddressSelectionScreen(currentAddress: currentAddress),
          ),
        );
      case RouteList.addressManagement:
        return _buildRoute(
          settings,
          (context) => ChangeNotifierProvider(
            create: (context) => AddressManagementModel(),
            ...
            return MultiProvider(
              providers: [
                ChangeNotifierProvider<ListApprovedRatingModel>(
                  create: (context) => ListApprovedRatingModel(user: arguments),
                ),
      ...
      case RouteList.bookingHistory:
        return _buildRoute(
          settings,
          (context) => Services().widget.renderBookingHistory(context),
        );

      case RouteList.resetPassword:
        final resetUrl = settings.arguments?.toString();
        return _buildRoute(
          settings,
          (context) => Services().widget.renderResetPasswordScreen(resetUrl),
        );
      ...
      default:
        ...
        if (allRoutes.containsKey(settings.name)) {
          return _buildRoute(settings, allRoutes[settings.name!]!);
        }
  ...
  static PageRouteBuilder _buildRouteFade(
    ...
    return _FadedTransitionRoute(settings: settings, builder: builder);
  }
  ...
  static Route _buildRoute(
    ...
    if (kIsWeb ||
      ...
      return _buildRouteFade(settings, builder);
    }
