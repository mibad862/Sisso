...
class FilterProductParams {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (serverConfig.isPrestashop) {
      result.addAll({'feature': feature, 'feature_term': featureTerm});
  ...
  factory FilterProductParams.fromJson(Map<String, dynamic> json) {
    ...
    if (serverConfig.isWooPluginSupported) {
      return FilterProductParams(
        ...
        onSale: bool.tryParse('${json['on_sale']}'),
    ...
    if (serverConfig.isPrestashop) {
      return FilterProductParams(
        ...
        featureTerm: json['feature_term']?.toString(),
      );
    }
