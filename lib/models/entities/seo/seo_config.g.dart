...
_SeoConfig _$SeoConfigFromJson(Map<String, dynamic> json) => _SeoConfig(
  ...
  metaKeyValue: json['metaKeyValue'] == null
      ? null
      : SeoMetaKeyValue.fromJson(json['metaKeyValue'] as Map<String, dynamic>),
  ...
  metaTwitter: json['metaTwitter'] == null
      ? null
      : SeoMetaTwitter.fromJson(json['metaTwitter'] as Map<String, dynamic>),
...
Map<String, dynamic> _$SeoConfigToJson(_SeoConfig instance) =>
    <String, dynamic>{
