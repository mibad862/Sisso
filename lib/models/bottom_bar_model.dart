...
class BottomBarModel with ChangeNotifier {
  ...
  /// Reset bottom bar to fully visible state
  /// Useful for ensuring bottom bar is shown when navigating to important screens
  void resetToVisible() {
    if (_opacity != _kMaxOpacity || _offset != _kDefaultOffset) {
      activeOpacityAndSlide();
    }
  }
