...
class _MediaItemCopyWith extends MediaItemCopyWith {
  ...
  FluxMediaItem call({
    ...
    id: id == _fakeNull ? value.id : id.toString(),
    title: title == _fakeNull ? value.title : title.toString(),
    album: album == _fakeNull ? value.album : album?.toString(),
    artist: artist == _fakeNull ? value.artist : artist?.toString(),
    genre: genre == _fakeNull ? value.genre : genre?.toString(),
    ...
    urlSource: urlSource == _fakeNull ? value.urlSource : urlSource.toString(),
