...
extension UserCommerceSettingsExtension on UserBox {
  List<String> get recentSearches {
    return List<String>.from(
      box.get(BoxKeys.recentSearches, defaultValue: <String>[]),
    );
  }
  ...
  List<String> get recentBlogsSearch {
    return List<String>.from(
      box.get(BoxKeys.recentBlogsSearch, defaultValue: <String>[]),
    );
  }
  ...
  String get savedCoupon {
    return box.get(BoxKeys.savedCoupon, defaultValue: '');
  }
  ...
  List<Map> get orders {
    final rawData = box.get(BoxKeys.orders, defaultValue: <Map>[]);
  ...
  List<Product> get wishList {
    final rawData = box.get(BoxKeys.wishList, defaultValue: <Product>[]);
    return List<Product>.from(rawData.map((e) => Product.fromLocalJson(e)));
  }
  ...
  List<Blog> get blogWishList {
    final rawData = box.get(BoxKeys.blogWishList, defaultValue: <Blog>[]);
    return List<Blog>.from(rawData.map((e) => Blog.fromLocalJson(e)));
  }
  ...
  List? get recentProducts {
    return box.get(BoxKeys.recentProducts);
  }
  ...
  List? get productsInCart {
    return box.get(BoxKeys.productsInCart);
  }
  ...
  String? get shopifyCartId {
    return box.get(BoxKeys.shopifyCartId, defaultValue: null);
  }

  set shopifyCartId(String? value) {
    if (value == null || value.isEmpty) {
      box.delete(BoxKeys.shopifyCartId);
      return;
    }
    box.put(BoxKeys.shopifyCartId, value);
  }

  Address? get shippingAddress {
    final rawData = box.get(BoxKeys.shippingAddress, defaultValue: null);
  ...
  List<Address> get addresses {
    final rawData = box.get(BoxKeys.addresses, defaultValue: null);
