...
class _ShoppingCartSummaryState extends State<ShoppingCartSummary> {
  ...
  void showError(String message) {
    final snackBar = SnackBar(
      ...
      action: SnackBarAction(label: S.of(context).close, onPressed: () {}),
    );
          ...
          (
            ...
            if (couponObj != null && (couponObj.amount ?? 0) > 0) {
              ...
              if (couponObj.discountType == 'percent') {
                ...
                couponMsg +=
                    ' - ${PriceTools.getCurrencyFormatted(couponObj.amount, currencyRate, currency: currency)}';
              }
            } else {
            ...
            final enableCoupon =
                kAdvanceConfig.enableCouponCode &&
              ...
              children: <Widget>[
                ...
                if (enablePointReward)
                  Padding(
                    ...
                    child: PointReward(cartStyle: widget.cartStyle),
                  ),
