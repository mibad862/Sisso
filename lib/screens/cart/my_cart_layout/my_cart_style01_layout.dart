...
class _MyCartStyle01LayoutState extends State<MyCartStyle01Layout>
    with MyCartMixin {
  void _onTapCheckout() async {
    final emptyCart = cartModel.totalCartQuantity == 0;
    final isConnectNetwork = await context.checkInternet(
      showErrorMessage: !emptyCart,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<CartModel, String?>(
      selector: (_, cartModel) =>
          '${cartModel.productsInCart.keys.firstOrNull}'
        ...
        return MediaQuery.removePadding(
          ...
          child: Scaffold(
            ...
            body: Selector<CartModel, (int, double)>(
              selector: (_, cartModel) =>
                  (cartModel.totalCartQuantity, cartModel.rewardTotal),
              builder: (context, selector, child) {
                ...
                return Column(
                  children: [
                      ...
                      child: CustomScrollView(
                        ...
                        slivers: [
                          ...
                          CupertinoSliverRefreshControl(
                            onRefresh: () => refreshCartProducts(cartModel),
                          ),
                          SliverToBoxAdapter(
                    ...
                    SlideOutOnKeyboard(child: renderTotalPrice(cartModel)),
                  ],
                );
              },
            ),
  ...
  Widget renderTotalPrice(CartModel modelCart) {
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        minimum: EdgeInsets.only(bottom: context.floatingTabBarInset),
        child: Column(
          children: [
                        ...
                        return ElevatedButton.icon(
                          ...
                          label: totalCartQuantity > 0
                              ? (isLoading
                                    ...
                                    : Text(
                                        primaryCheckoutLabel.toUpperCase(),
                                        style: style,
                                      ))
                              : Text(
...
class _PriceWidget extends StatelessWidget {
  const _PriceWidget({this.currency, required this.currencyRate});
