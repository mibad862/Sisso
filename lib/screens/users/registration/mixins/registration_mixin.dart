...
mixin RegistrationMixin<T extends StatefulWidget> on State<T> {
  ...
  Future<void> submitRegister({
    ...
    final isInvalidFirstName =
        kAuthConfig.registration.firstName.require && firstName.isEmptyOrNull;
    final isInvalidLastName =
        kAuthConfig.registration.lastName.require && lastName.isEmptyOrNull;
    final isInvalidEmail =
        kAuthConfig.registration.requireEmail && emailAddress.isEmptyOrNull;
    final isInvalidUserInfo =
        isInvalidFirstName ||
        isInvalidLastName ||
        isInvalidEmail ||
    ...
    final isInvalidUsername =
        kAuthConfig.registration.requireUsername && username.isEmptyOrNull;
  ...
  void _showMessage(String text, {bool isError = true}) {
    ...
    FlashHelper.message(context, message: text, isError: isError);
  }
}
