...
class _VerifyCodeState extends State<VerifyCode>
  ...
  Future<void> _verifySuccessStreamListener(String? otp) async {
    _pinCodeController.setText(otp ?? '');
    Tools.hideKeyboard(context);
  }
          ...
          children: <Widget>[
                ...
                child: Text.rich(
                  TextSpan(
                    ...
                    style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                      color: Theme.of(
                        context,
                      ).textTheme.bodyMedium?.color?.withValueOpacity(0.54),
                      fontSize: 15,
                    ),
                  ),
                  textAlign: TextAlign.center,
              ...
              child: Directionality(
                ...
                child: MaterialPinField(
                  ...
                  theme: MaterialPinTheme(
                    ...
                    borderWidth: 2,
                    filledFillColor: Theme.of(context).colorScheme.surface,
            ...
            Container(
              ...
              child: StaggerAnimation(
                ...
                onTap: () {
                  if (_pinCodeController.text.trim().length == otpLength) {
  ...
  Future<void> _signInWithCredential(credential) async {
    final user = await Services().firebase.loginFirebaseCredential(
