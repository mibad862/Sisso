...
class _FlatStyleDetailProductWidgetState
  ...
  bool _listenerNotificationOfScroll(
    ...
    if (enableAutoHideButtonBuy) {
      if (notification is ScrollUpdateNotification) {
        ...
        _priceWidgetController.value = delta > 0
            ? 0
            : delta < -bottomWidgetHeight
            ? -bottomWidgetHeight
            : delta;
      } else if (notification is UserScrollNotification &&
          notification.direction == ScrollDirection.idle) {
        if ((_priceWidgetController.value).abs() > (bottomWidgetHeight * 0.8)) {
          _priceWidgetController.value = -bottomWidgetHeight;
        } else {
  ...
  Widget build(BuildContext context) {
    ...
    final bottomWidgetHeight =
        _kSizeBttomWidget + (detailPriceData.isShowCountDown ? 25.0 : 0.0);
    ...
    return Column(
      children: [
        Expanded(
          child: Stack(
            children: [
              _renderDetailProduct(detailPriceData, bottomWidgetHeight),
    ...
    return Scaffold(
      ...
      body: NotificationListener<ScrollNotification>(
        onNotification: (notification) =>
            _listenerNotificationOfScroll(notification, bottomWidgetHeight),
        child: Stack(
          children: [
            CustomScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Services().widget.renderVendorInfo(
                                widget.product,
                              ),
                              Services().renderTieredPriceTable(widget.product),
                      ...
                      decoration: BoxDecoration(
                        boxShadow: [
                          BoxShadow(
                            ...
                            color: Theme.of(
                              context,
                            ).scaffoldBackgroundColor.withValueOpacity(1),
                      ...
                      child: ClipPath(
                        child: Container(
                          decoration: BoxDecoration(
                            color: Theme.of(
                              context,
                            ).colorScheme.surface.withValueOpacity(0.5),
                          ),
                          ...
                          child: Builder(
                            builder: (context) {
                              var model = Provider.of<ProductVariantModel>(
                                context,
                              );
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          if (kProductDetail.showPrice)
                                            Services().widget.renderDetailPrice(
                                              context,
                                              product,
                                              detailPriceData,
                                              isShowCountDown: detailPriceData
                                                  .isShowCountDown,
                                              countDown:
                                                  detailPriceData.countDown,
                                          ...
                                          QuantitySelection(
                                            ...
                                            style:
                                                QuantitySelectionStyle.style01,
                                          ),
                                        ],
                                      ),
                                    ),
