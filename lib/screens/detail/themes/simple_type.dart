                          ...
                          body: CustomScrollView(
                            ...
                            slivers: <Widget>[
                              SliverAppBar(
                                ...
                                elevation: 1.0,
                                expandedHeight: Layout.isDisplayDesktop(context)
                                    ? 0
                                    : height * kProductDetail.height,
                                pinned: true,
                                floating: false,
                                leading: Padding(
                                  ...
                                  child: CircleAvatar(
                                    backgroundColor: Theme.of(
                                      context,
                                    ).primaryColorLight.withValueOpacity(0.7),
                                    child: IconButton(
                                      icon: Icon(
                                        Icons.close,
                                ...
                                flexibleSpace: Builder(
                                  builder: (context) {
                                    return Layout.isDisplayDesktop(context)
                                        ? const SizedBox()
                                        : kProductDetail
                                              .productImageLayout
                                              .isList
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Services().renderTieredPriceTable(
                                              product,
                                            ),
                                            Services()
