      ...
      return Text.rich(
        TextSpan(
          ...
          children: [
            TextSpan(
              text:
                  '- ${TimeAgo.toUnitString(duration, unit: unit, langCode: langCode)}',
  ...
  Widget _buildSalePrice(
    ...
    final textRegularPrice = Text(
      ...
      style: Theme.of(context).textTheme.titleMedium!.copyWith(
        color: Theme.of(context).colorScheme.secondary.withValueOpacity(0.6),
    ...
    /// render price
    final textPrice = Text(priceString, style: style);
