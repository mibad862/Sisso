...
class BuyButtonWidget extends StatelessWidget {
  ...
  int _getMaxQuantity(Product product, ProductVariation? productVariation) {
    var maxAllowQuantity = product.maxQuantity ?? kCartDetail.maxAllowQuantity;
  ...
  void _addToCart(
    ...
    var selectedTieredPrice = model.selectedTieredPrice;
    var tieredPrices = model.tieredPrices;
