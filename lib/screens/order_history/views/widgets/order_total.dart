      ...
      child: Column(
        children: <Widget>[
          if (order.deliveryDate != null && order.storeDeliveryDates == null)
            _CustomListTile(
              leading: S.of(context).expectedDeliveryDate,
              trailing: order.deliveryDate!,
            ),
          if ((order.deliveryTime?.isNotEmpty ?? false) &&
              order.storeDeliveryDates == null)
            _CustomListTile(
              leading: S.of(context).expectedDeliveryTime,
              trailing: order.deliveryTime!,
            ),
          ...
          const SizedBox(height: 10),
          ...List.generate(order.feeLines.length, (index) {
          ...
          Divider(height: 20, color: theme.colorScheme.secondary),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text(
