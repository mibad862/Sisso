...
import '../../detail/widgets/video_feature.dart';
...
class _BlogDetailScreenWebState extends BaseScreen<BlogDetailScreenWeb>
  ...
  void afterFirstLayout(BuildContext context) async {
    if (widget.id != null) {
      final data = await Services().api.getBlogById(widget.id);
      if (data != null) {
        blog = data;
        setState(() {});
      }
      ...
      child: Builder(
        builder: (context) {
          return SliverWebLayout(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      HtmlWidget(
                        ...
                        onTapUrl: (url) async {
                          if (Services().dynamicLinkService.isSupportedLink(
                            url,
                          )) {
                            return await Services().dynamicLinkService
                                .handleLink(url);
                          }
                          return false;
                        },
            ...
            pathHeaders: [PathHeaderItem(title: S.of(context).blog)],
          );
        },
      ),
    );
