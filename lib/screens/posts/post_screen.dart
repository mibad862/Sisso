...
class _PostScreenState extends State<PostScreen> with AppBarMixin {
  ...
  Future<Blog?> getPageById(context) =>
      _memoizer.runOnce(() => _service.api.getPageById(widget.pageId));
...
class PostView extends StatelessWidget {
  ...
  const PostView({this.item, this.scrollController});
