    ...
    _PostBackdrop backdrop({blogs, isFetching, errMsg, isEnd}) => _PostBackdrop(
      backdrop: Backdrop(
        ...
        backLayer: FilterWidget(
          ...
          showLayout: kFilterConfig.showLayout,
          showSort: kFilterConfig.showSort,
          showCategory: kFilterConfig.showCategory,
          showListingLocation: false,
          showPriceSlider: false,
          showTag: kFilterConfig.showTag,
          showAttribute: false,
          showFeature: false,
          showBrand: false,
        ...
        backTitle: Center(
          child: Text(S.of(context).filter, style: TextStyle(color: textColor)),
        ),
...
class _PostBackdrop extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Stack(children: <Widget>[backdrop]);
  }
}
