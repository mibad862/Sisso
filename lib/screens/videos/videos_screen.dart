...
class VideosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<VideosModel>(
      create: (_) => VideosModel(order: order, orderby: orderby),
      child: _VideoScreen(styleVersions: styleVersions),
    );
  }
}
...
class __VideoScreenState extends State<_VideoScreen> with AppBarMixin {
  ...
  Widget _renderVideoPage(VideosModel model, int index, double maxHeight) {
    ...
    final styleVersions = widget.styleVersions;
    final styleVersion = styleVersions.isNotEmpty
        ? styleVersions[index % styleVersions.length]
        : null;
