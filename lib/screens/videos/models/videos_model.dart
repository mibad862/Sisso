...
class VideosModel extends ChangeNotifier {
  ...
  VideosModel({this.order, this.orderby});

  late final _videoService = VideosService(order: order, orderby: orderby);
  ...
  Future<void> loadMoreItem() async {
    ...
    final listProduct = await _videoService.loadMoreItems();
  ...
  Future<void> init() async {
    ...
    final listProduct = await _videoService.refreshItems();
    _autoFetch = listProduct.isNotEmpty;
