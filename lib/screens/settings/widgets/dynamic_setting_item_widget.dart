...
import 'setting_item/setting_item_delivery_online_widget.dart';
...
class _DynamicSettingItemWidgetState extends State<DynamicSettingItemWidget>
  ...
  Widget build(BuildContext context) {
    ...
    var subGeneralSetting = widget.subGeneralSetting != null
        ...
        : kSubGeneralSetting;
    final isVendorAndDeliverySupported =
    ...
    switch (widget.type) {
      ...
      case 'products':
        {
          ...
          icon = CupertinoIcons.cube_box;
          onTap = () =>
              FluxNavigate.pushNamed(RouteList.productSell, context: context);
          break;
        }
      ...
      case 'order':
        {
          ...
          final user = (ServerConfig().isHaravan && loggedIn == false)
              ? null
              : userModel.user;
          if (user == null || ServerConfig().isPureListing) {
            return const SizedBox();
          }
      ...
      case 'booking':
        {
          if (widget.user == null ||
              !(ServerConfig().isListeoType || ServerConfig().isFirebase)) {
            return const SizedBox();
          }
      ...
      case 'deliveryOnline':
        {
          return SettingDeliveryOnlineWidget(
            cardStyle: _cardStyle,
            user: widget.user,
          );
        }
      ...
      case 'addListing':
        {
          return Services().widget.renderNewListing(context, _cardStyle);
        }
