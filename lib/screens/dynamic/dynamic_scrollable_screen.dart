...
class DynamicScrollableScreenState extends BaseScreen<DynamicScrollableScreen>
  ...
  int? itemId;
  late final ValueNotifier<double> _offsetNotifier = ValueNotifier(
    1 - _initialSize,
  );
  ...
  Widget renderLayout({
    ...
    final configs = widget.data[index].jsonData['configs'];
    ...
    return Stack(
      children: [
        if (backgroundConfig != null) HomeBackground(config: backgroundConfig),
                ...
                builder: (context, value, child) {
                  return FractionallySizedBox(
                    ...
                    child: renderLayout(
                      ...
                      appConfig: appConfig,
                      showNewAppBar:
                          appConfig.appBar?.shouldShowOn(
                            RouteList.scrollable,
                          ) ??
                          false,
