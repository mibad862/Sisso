...
class Analytics {
  ...
  static void _triggerEvent(AnalyticsEvent value, {AnalyticData? data}) {
  ...
  static void triggerLogin({String? method}) {
    _triggerEvent(AnalyticsEvent.login, data: AnalyticData(data: method));
  }

  static void triggerRegister({String? method}) {
    _triggerEvent(AnalyticsEvent.register, data: AnalyticData(data: method));
  }
  ...
  static void triggerAddToCart(
    ...
    _triggerEvent(
      ...
      data: AnalyticData(data: value, context: context, quantity: quantity),
    );
  }
  ...
  static void triggerViewCart(Map? value, BuildContext? context) {
    _triggerEvent(
      ...
      data: AnalyticData(data: value, context: context),
    );
  }
  ...
  static void triggerCreateRefund(Order? value) {
    _triggerEvent(AnalyticsEvent.createRefund, data: AnalyticData(data: value));
  }

  static void triggerAddShippingInfo(String? value, BuildContext? context) {
    _triggerEvent(
      AnalyticsEvent.addShippingInfo,
      data: AnalyticData(data: value, context: context),
    );
  }
  ...
  static void triggerTapBlog(Blog? value) {
    _triggerEvent(AnalyticsEvent.tapBlog, data: AnalyticData(data: value));
  }
  ...
  static void triggerSearchProduct(
    ...
    _triggerEvent(
      ...
      data: AnalyticData(data: value, isEmpty: isEmpty, context: context),
    );
  }

  static void triggerSelectPromotion({
    String? promotionId,
    String? promotionName,
  }) {
    _triggerEvent(
      AnalyticsEvent.selectPromotion,
      data: AnalyticData(
        data: {'promotionId': promotionId, 'promotionName': promotionName},
      ),
    );
  }
