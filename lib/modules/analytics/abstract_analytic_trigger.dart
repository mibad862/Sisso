  ...
  void onListener((AnalyticsEvent, AnalyticData?) event) {
    switch (event.$1) {
      case AnalyticsEvent.login:
        final method = event.$2?.data;
        onLogin(method is String ? method : null);
        break;
      case AnalyticsEvent.register:
        final method = event.$2?.data;
        onRegister(method is String ? method : null);
        break;
      ...
      case AnalyticsEvent.searchProduct:
        ...
        break;
      case AnalyticsEvent.selectPromotion:
        var value = event.$2?.data;
        if (value is Map) {
          onSelectPromotion(value['promotionId'], value['promotionName']);
        }
        break;
    }
  }
