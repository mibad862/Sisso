              ...
              children: [
                HeaderView(
                  ...
                  callback: () => FluxNavigate.pushNamed(
                    RouteList.geoSearch,
                    arguments: GeoSearchArgs(stores: model.stores),
                    context: context,
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    if (store == null) {
      return Container(
        ...
        child: const Skeleton(width: 140, height: 160),
      );
    }
          ...
          children: [
            AspectRatio(
              ...
              child: ClipRRect(
                ...
                child: ImageResize(url: store!.bannerUrl, fit: BoxFit.cover),
              ),
            ),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      SmoothStarRating(rating: store?.rating, size: 10.0),
