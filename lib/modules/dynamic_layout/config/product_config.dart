...
class ProductConfig {
  ...
  StoreStyle storeStyle = StoreStyle.normal;
  ...
  /// `null` means use the default behavior from the current `Directionality`.
  /// `true` forces the image to be on the left (as in LTR layout), regardless of locale.
  /// `false` forces the image to be on the right (as in RTL layout), regardless of locale.
  /// Only applies to ListTile layout.
  bool? imageOnLeft;
  ...
  bool get hideStore => storeStyle.isHide;
  set hideStore(bool value) {
    storeStyle = (value ? StoreStyle.hide : StoreStyle.normal);
  }
  ...
  ProductConfig.empty() {
    ...
    storeStyle = kProductCard.storeStyle;
    hideAddress = kProductCard.hideAddress;
    ...
    showStockQuantity = kAdvanceConfig.showStockQuantity;
    ...
    showPhoneNumber = kProductCard.showPhoneNumber;
    showShortDescription = kProductCard.showShortDescription;
  ...
  ProductConfig.fromJson(dynamic json) {
    ...
    showHeart = json['showHeart'] ?? env.showHeart;
    showProductCardCategory =
        json['showProductCardCategory'] ?? env.showProductCardCategory;
    showListingType = json['showListingType'] ?? env.showListingType;
    showPhoneNumber = json['showPhoneNumber'] ?? env.showPhoneNumber;
    showShortDescription =
        json['showShortDescription'] ?? env.showShortDescription;
    ...
    if (json['animationConfig'] != null) {
      animationConfig = AnimatedItemListConfig.tryParse(
    ...
    if (json['border'] != null) {
      if (json['border']['all'] != null) {
        final borderSideAll = const BorderSideConverter().fromJson(
          json['border']['all'],
        );
        ...
        border = BorderDirectional(
          ...
          bottom: const BorderSideConverter().fromJson(
            json['border']['bottom'],
          ),
        );
      }
    ...
    showCountDown =
        (json['showCountDown'] ?? env.showCountDown) &&
    ...
    storeStyle = StoreStyle.parseStoreStyleFromConfig(
      json,
      fallbackStyle: env.storeStyle,
    );
    hideAddress = json['hideAddress'] ?? env.hideAddress;
    showStockStatus = json['showStockStatus'] ?? env.showStockStatus;
    showStockQuantity = json['showStockQuantity'] ?? env.showStockQuantity;
    ...
    imageOnLeft = bool.tryParse('${json['imageOnLeft']}');
    ...
    advancedParams = json['advancedParams'] is Map
        ? json['advancedParams']
        : {};
    ...
    durationAutoSliding =
        Helper.formatInt(json['durationAutoSliding']) ??
  ...
  Map<String, dynamic> toJson() {
    ...
    map['showShortDescription'] = showShortDescription;
...
extension ProductConfigExtension on ProductConfig {
  TextDirection? get textDirectionForListTileLayout => imageOnLeft == null
      ? null
      : imageOnLeft!
      ? TextDirection.ltr
      : TextDirection.rtl;
