...
_WebEmbedConfig _$WebEmbedConfigFromJson(Map<String, dynamic> json) =>
    _WebEmbedConfig(
      type:
          $enumDecodeNullable(_$WebEmbedTypeEnumMap, json['type']) ??
          WebEmbedType.url,
...
Map<String, dynamic> _$WebEmbedConfigToJson(_WebEmbedConfig instance) =>
    <String, dynamic>{
