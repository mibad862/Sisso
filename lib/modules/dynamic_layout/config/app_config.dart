...
class AppConfig {
  ...
  bool? get showQRCode {
    final searchTab = (jsonData['TabBar'] as List).firstWhereOrNull(
      (e) => e['layout'] == 'search',
    );
  ...
  AppConfig.fromJson(dynamic json) {
    ...
    _privacyPoliciesPageUrlOrId = json['PrivacyPoliciesPageUrlOrId']
        ?.toString();
...
class TabBarMenuConfig {
  ...
  TabBarMenuConfig copyWith({ScrollController? scrollController}) {
...
class AppBarItemConfig {
  ...
  AppBarItemConfig.fromJson(dynamic json) {
    ...
    productType = json['productType'] ?? productType;
  }
