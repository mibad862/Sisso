...
class _StateBannerSlider extends State<BannerSlider> {
  ...
  Widget renderBannerItem({
    ...
    return BannerItemWidget(
      ...
      videoConfig: widget.config.videoConfig,
    );
  }
    ...
    switch (widget.config.design) {
      case 'swiper':
        return Swiper(
          ...
          viewportFraction: Tools.isTablet(MediaQuery.of(context))
              ? 0.55
              : 0.85,
          scale: 0.9,
    ...
    return BackgroundColorWidget(
      ...
      child: LayoutBuilder(
        builder: (context, constraint) {
          var bannerPercentWidth =
              widget.config.overrideBannerPercentWidth ??
