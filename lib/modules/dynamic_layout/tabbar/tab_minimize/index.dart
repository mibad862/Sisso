...
class _TabMinimizeState extends State<TabMinimize>
  ...
  void initState() {
    ...
    setupAnimations(animationsMap.values.where((anim) => true), this);
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 16, 24),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.end,
        children: [
          IgnorePointer(
            ignoring: !_openTabMenu,
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Colors.black.withValueOpacity(0.15),
                    blurRadius: 40.0,
                          ...
                          : InkWell(
                              ...
                              child: Padding(
                                ...
                                child: TabBarIcon(
                                  ...
                                  isHorizontal: true,
                                ).animateOnTap(animationsMap[i.toString()]!),
                              ),
                            ),
                  ],
                ),
              ),
            ).animateOnTap(animationsMap['container']!),
          ),
          Padding(
                  ...
                  child: Stack(
                    ...
                    children: [
                      const Icon(
                        ...
                        color: Colors.white,
                        size: 22,
                      ).animateOnTap(animationsMap['iconFly']!),
                      const Icon(
                        Icons.close_rounded,
                        color: Colors.white,
                        size: 24,
                      ).animateOnTap(animationsMap['iconClosed']!),
                    ],
                  ),
                ),
              ),
