...
import '../../../models/index.dart'
    show Category, CategoryModel, Product, ProductModel, UserModel;
...
class _StateMenuLayout extends State<MenuLayout> {
  ...
  List<Category>? getAllCategory() {
    final categorieList = Provider.of<CategoryModel>(
      context,
      listen: true,
    ).categories;
    ...
    if (loadingNotifier.value == true && categories.isNotEmpty) {
      getAllListProducts(category: categories[position]);
    }
    return categories;
  }
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            ...
                            getAllListProducts(category: categories[index]);
                          },
                          child: Padding(
