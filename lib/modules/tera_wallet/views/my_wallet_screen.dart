...
import '../../../common/config/models/wallet_config.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.endOfFrame.then((_) {
      if (mounted) {
        ...
        if (_walletModel.walletTransactionModel.data.isEmpty) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Selector<WalletTransactionModel, List<Transaction>?>(
                    selector: (_, model) =>
                        model.isFirstLoad ? null : model.data.take(10).toList(),
          ...
          children: [
            Transform.rotate(
              ...
              child: _buildCardFake(
                Theme.of(context).colorScheme.secondary.withValueOpacity(0.1),
              ),
            ),
            Transform.rotate(
              angle: -math.pi / 35,
            ...
            Consumer<WalletModel>(
              builder: (context, model, child) {
                return _buildCardInfo(
                  color: Theme.of(context).primaryColor.withValueOpacity(0.9),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  kWalletConfig.getTeraWalletName(context),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          if (kWalletConfig.enableTeraWalletWithdrawal)
            _buildCardActionItem(
          ...
          _buildCardActionItem(
            actionName: S.of(context).history,
            onTap: () => Navigator.of(
              context,
    ...
    return TextButton(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(actionName, style: Theme.of(context).textTheme.labelLarge),
        ],
      ),
    );
  }
