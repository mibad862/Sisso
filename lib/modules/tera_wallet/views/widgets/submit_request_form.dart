...
class _SubmitRequestFormState extends State<SubmitRequestForm> {
  ...
  late WalletPaymentMethod? _selected = Provider.of<WalletRequestModel>(
    context,
    listen: false,
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<WalletRequestModel>(
                    ...
                    child: TextFormField(
                      ...
                      decoration: defaultInputDecoration(context).copyWith(
                        prefix: Padding(
                          ...
                          child: Text(
                            kCurrencyConfig.defaultCurrency?.symbol ?? '',
                            style: Theme.of(context).textTheme.titleSmall
                                ?.copyWith(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 14,
              ...
              GestureDetector(
                onTap: () {
                  if (enableBtn) {
                    ...
                    model
                        .submitRequest(_selected!, _amount!)
                        .then((value) {
                          setState(() {
