...
class _SMSInputPhoneV2State extends State<SMSInputPhoneV2>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final matchedElement = elements
          .where((element) => element.code == defaultCountry.countryCode)
          .firstOrNull;
      model.updateCountryCode(
        CountryCode(
          code: defaultCountry.countryCode,
          dialCode: defaultCountry.dialCode,
          name: defaultCountry.name,
          flagUri: matchedElement?.flagUri,
        ),
      );
    });
  }
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: Theme.of(context).textTheme.headlineSmall?.copyWith(
                      color: Theme.of(
                        context,
                      ).textTheme.headlineSmall?.color?.withValueOpacity(0.75),
                    ),
                  ),
                          ...
                          TextSpan(
                            ...
                            recognizer: TapGestureRecognizer()
                              ..onTap = () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const PrivacyTermScreen(
