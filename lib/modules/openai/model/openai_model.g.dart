...
_ChatGPT _$ChatGPTFromJson(Map<String, dynamic> json) => _ChatGPT(
  ...
  revenueProductsIos:
      (json['revenueProductsIos'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  revenueProductsAndroid:
      (json['revenueProductsAndroid'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);

Map<String, dynamic> _$ChatGPTToJson(_ChatGPT instance) => <String, dynamic>{
