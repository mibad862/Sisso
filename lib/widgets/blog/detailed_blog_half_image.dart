...
class HalfImageType extends StatelessWidget with DetailedBlogMixin {
  ...
  const HalfImageType({super.key, required this.item});
    ...
    return Stack(
      children: <Widget>[
        SizedBox(
          ...
          width: size.width,
          child: FluxImage(imageUrl: blogData.imageFeature, fit: BoxFit.cover),
        ),
        Scaffold(
            ...
            leading: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Theme.of(
                    context,
                  ).colorScheme.surface.withValueOpacity(0.3),
