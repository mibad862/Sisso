...
class StoreItem extends StatelessWidget {
  ...
  String get profileUrl => store.profileUrl;
  String get bannerUrl => store.bannerUrl;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: theme.colorScheme.primary.withValueOpacity(0.4),
...
class StoreStatusWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (!kAdvanceConfig.showOpeningStatus) {
      ...
      children: [
        ...
        if (store.storeHour != null && store.vacationSettings != null) ...[
          if (store.vacationSettings!.vacationMode) ...[
            if (!store.vacationSettings!.isOpen()) ...[
              const SizedBox(height: 5.0),
              Row(
                children: [
                  const Icon(Icons.schedule, color: Colors.red, size: 12.0),
        ...
        if (store.storeHour != null && store.vacationSettings == null) ...[
          ...
          Row(
            children: [
              ...
              Text(
                store.storeHour!.isOpen()
                    ? (store.storeOpenNote != null)
                          ? store.storeOpenNote!
                          : S.of(context).openNow
                    : (store.storeCloseNote != null)
                    ? store.storeCloseNote!
                    : S.of(context).closeNow,
                style: theme.textTheme.bodySmall!.copyWith(
                  color: store.storeHour!.isOpen() ? Colors.green : Colors.red,
                  fontSize: 12.0,
