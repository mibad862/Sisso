...
class FeaturedLayout extends StatefulWidget {
  ...
  const FeaturedLayout({required this.config, super.key});
...
class _FeaturedLayoutState extends State<FeaturedLayout> {
  ...
  Widget placeholder(Size size) {
    return Skeleton(width: size.width, height: size.height);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BackgroundColorWidget(enable: config.enableBackground, child: child);
  }
}
