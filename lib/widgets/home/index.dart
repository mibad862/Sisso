...
class _HomeLayoutState extends State<HomeLayout> with AppBarMixin {
  ...
  void initState() {
    ...
    final verticalLayout = widget.configs?['VerticalLayout'];
    if (verticalLayout is Map && verticalLayout.isNotEmpty) {
      Map verticalData = Map<String, dynamic>.from(verticalLayout);
  ...
  Future<void> onRefresh() async {
    ...
    final newAppconfig = await appModel.loadAppConfig();
