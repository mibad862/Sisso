...
class _SocialLoginButtonRowState extends State<SocialLoginButtonRow> {
  ...
  /// in [kAuthConfig.providers.apple.enable] config
  /// and the Apple login is available.
  bool get showAppleButton =>
      kAuthConfig.providers.apple.enable &&
  ...
  Widget build(BuildContext context) {
    if (!ServerConfig().isSocialLoginSupported) {
    ...
    return Row(
      ...
      children: [
        if (widget.onApplePressed != null && showAppleButton)
          AnimatedContainer(
        ...
        if (kAuthConfig.providers.facebook.enable &&
            widget.onFacebookPressed != null)
          Padding(
        ...
        if (kAuthConfig.providers.google.enable &&
            widget.onGooglePressed != null)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: horizontalPadding),
        ...
        if (kAuthConfig.providers.sms.enable && widget.onSmsPressed != null)
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: horizontalPadding),
