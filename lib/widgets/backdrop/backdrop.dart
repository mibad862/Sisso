...
class _BackdropTitle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTextStyle(
      style: Theme.of(
        context,
      ).textTheme.titleLarge!.copyWith(color: titleColor ?? Colors.white),
      softWrap: false,
...
class _BackdropState extends State<Backdrop>
  ...
  Animation<RelativeRect> _getLayerAnimation(Size layerSize, double layerTop) {
    ...
    return TweenSequence(<TweenSequenceItem<RelativeRect>>[
          ...
          child: Theme(
            data: Theme.of(context).copyWith(
              colorScheme: Theme.of(
                context,
              ).colorScheme.copyWith(secondary: labelColor),
            ...
            AppBar(
              ...
              actions: <Widget>[
                ...
                if (dynamicLinkConfig.allowShareLink &&
                    ServerConfig().isSupportShareProductList &&
                    !widget.isBlog)
                  IconButton(
                    icon: Icon(Icons.share, size: 18.0, color: labelColor),
