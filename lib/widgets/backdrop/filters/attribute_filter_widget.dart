...
class AttributeFilterWidgetState extends State<AttributeFilterWidget> {
  ...
  void initState() {
    ...
    currentAttribute =
        _listSelectedAttributes.entries.firstOrNull?.key ??
  ...
  void _onTapSubAttribute(int attributeId, SubAttribute subAttribute) {
    ...
    final isExist =
        selectedSubAttribute.firstWhereOrNull(
  ...
  Widget _renderSubAttributeList(
    ...
    return Container(
      ...
      child: Wrap(
        children: [
          for (var subAttribute
              in model.lstSubAttribute[currentAttribute?.id] ??
                  <SubAttribute>[])
            if (subAttribute.isVisible)
              SubAttributeItem(
                name: subAttribute.name ?? '',
                isSelected:
                    _listSelectedAttributes.entries.firstWhereOrNull(
                      (sub) =>
