...
import '../../models/index.dart' show Product, AppModel;
...
class ProductCard extends StatelessWidget with ActionButtonMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final currencyRates = appModel.currencyRate;
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              SizedBox(
                height:
                    kProductDetail.productListItemHeight *
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    PhoneItem(item: product, show: config.showPhoneNumber),
                    TagItem(item: product, hide: config.hideAddress),
          ...
          if (!ServerConfig().isListingType &&
            ...
            Padding(
              ...
              child: CartIcon(config: config, product: product, iconSize: 24.0),
            ),
        ],
      ),
    );
