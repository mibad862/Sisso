  ...
  Widget build(BuildContext context) {
    ...
    final infosWidget = [
      ...
      if (!stateUI.isOnBackorder &&
        ...
        Text(
          S.of(context).maximumQuantityAllowed(stateUI.limitQuantity),
          style: const TextStyle(color: Colors.red),
        ),
      Row(
        ...
        children: [
          ...
          if (stateUI.showQuantity)
            QuantitySelection(
              enabled:
                  (stateUI.inStock || stateUI.isOnBackorder) &&
              ...
              onChanged: (value) {
                var quantity = value == -1 ? 1 : value;
                if (quantity > stateUI.limitQuantity) {
                  quantity = stateUI.limitQuantity;
                }
                return stateUI.onChangeQuantity?.call(quantity) ?? true;
              },
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  constraints: const BoxConstraints(minHeight: _kMinHeightCard),
                  child: Column(
                    children: [
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
