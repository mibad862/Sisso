  ...
  Widget build(BuildContext context) {
    ...
    if (widget.hideDetail) {
      return ProductImage(
        ...
        onTapProduct: () =>
            onTapProduct(context, product: item, config: productConfig),
      );
    }
    ...
    Widget productInfo = Column(
      ...
      children: [
        ...
        StoreName(store: item.store, storeStyle: productConfig.storeStyle),
        Align(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        StockStatus(product: item, config: productConfig),
                        const SizedBox(height: 2),
                        ProductRating(
                          product: item,
    ...
    return GestureDetector(
      onTap: () => onTapProduct(context, product: item, config: productConfig),
