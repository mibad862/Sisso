...
import '../../common/config.dart'
    show kProductCard, kProductDetail, kSaleOffProduct, kSearchConfig;
...
class _ProductListState extends State<ProductList> {
  ...
  Widget build(BuildContext context) {
    ...
    final productsList = hasNoProduct && widget.isFetching
        ? emptyList
        : widget.products;
      ...
      child: SmartRefresher(
        ...
        child: CustomScrollView(
          ...
          slivers: <Widget>[
            ...
            typeList,
            SliverToBoxAdapter(
              child: SizedBox(height: context.floatingTabBarInset),
            ),
          ],
        ),
      ),
          ...
          return ConditionBuilderWidget(
            ...
            child: Services().widget.renderProductCardView(
              ...
              config: ProductConfig.empty()
                ...
                ..showCartIcon =
                    ProductConfig.empty().showCartIcon &&
