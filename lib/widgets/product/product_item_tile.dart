      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Flexible(
              flex: 3,
              child: _ProductDescription(item: item, config: config),
            ),
          ],
        ),
      ),
...
class _ProductDescription extends StatefulWidget {
  ...
  const _ProductDescription({required this.item, required this.config});
...
class _ProductDescriptionState extends State<_ProductDescription>
  ...
  @override
  void didUpdateWidget(covariant _ProductDescription oldWidget) {
    ...
    return Padding(
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            ListingTypeName(product: item, show: config.showListingType),
            CategoryName(product: item, show: config.showProductCardCategory),
            ProductTitle(
              product: item,
            ...
            ShortDescription(product: item, show: config.showShortDescription),
            StoreName(store: item.store, storeStyle: config.storeStyle),
