...
class WebViewInAppState extends StateWebviewInterface<WebViewInApp>
  ...
  void initState() {
    ...
    pullToRefreshController = PullToRefreshController(
      settings: PullToRefreshSettings(color: Colors.black45),
      onRefresh: () async {
  ...
  /// Helper method to request a permission and check if it's granted
        ...
        InAppWebView(
          ...
          onPermissionRequest: (controller, request) async {
            ...
            if (resources.contains(
              ...
              // When both camera and microphone are requested, check both
            ...
            } else if (resources.contains(PermissionResourceType.MICROPHONE)) {
              // Handle microphone only
