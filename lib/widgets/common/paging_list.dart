...
typedef PagingWidgetBuilder<T> =
    Widget Function(BuildContext, T entity, int index);
                              ...
                              transitionBuilder: (child, animation) {
                                ...
                                return SlideTransition(
                                  ...
                                  child: SizeTransition(
                                    ...
                                    alignment: const Alignment(-1.0, -1.75),
                                    axis: Axis.vertical,
                                    child: child,
                                  ),
                                );
  ...
  Widget _buildInitBody() {
    return widget.loadingWidget != null
        ? SliverList.separated(
            ...
            itemCount: widget.lengthLoadingWidget,
          )
        : SliverFillRemaining(child: widget.loadingWidget);
  }
}
